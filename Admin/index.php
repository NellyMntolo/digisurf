      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="/Admin/Home" style="color:white;"><i class="fa fa-dashboard text-lime"></i> <span>Dashboard</span></a></li>
          ...
          <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">Published Teachers</span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number"><?php echo $views;?>35</span>
                </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
            </div><!-- /.col -->
          </div><!-- /.row -->
        ...
        <div class="col-md-4" >
              <div class="box box-solid bg-maroon-gradient">
                <div class="box-header with-border">
                  <h3 class="box-title">Recently Added Workshops</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <div id="carousel-example-generic2" class="carousel slide" data-ride="carousel">
                    ...
                    <?php
                     $row_recentprojects_en1 = mysql_fetch_array($retval_recentprojects_en1, MYSQL_ASSOC);
                      $text1 = $row_recentprojects_en1['text4'];
                      $image1 = $row_recentprojects_en1['image1']; 
                    ...
                    <?php while($row_recentprojects_en = mysql_fetch_array($retval_recentprojects_en, MYSQL_ASSOC)){
                      $text2 = $row_recentprojects_en['text4'];
                      $image2 = $row_recentprojects_en['image1']; 
                      echo '<div class="item">
              ...
              <div class="box box-solid bg-light-blue-gradient">
                ...
                <div class="box-body">
                  <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" style="min-height: 150px;">
                    <?php
                     $row_recentsolutions_en1 = mysql_fetch_array($retval_recentsolutions_en1, MYSQL_ASSOC);
                      $text1 = $row_recentsolutions_en1['text4'];
                      $image1 = $row_recentsolutions_en1['image1']; 
                      echo '<div class="item active">
                            <img src="'.$image1.'" alt="'.$text1.'">
                            <div class="carousel-caption">
                              '.$text1.'
                    ...
                    <?php while($row_recentsolutions_en = mysql_fetch_array($retval_recentsolutions_en, MYSQL_ASSOC)){
                      $text2 = $row_recentsolutions_en['text4'];
                      $image2 = $row_recentsolutions_en['image1']; 
                      echo '<div class="item">
                            <img src="'.$image2.'" alt="'.$text2.'">
                            <div class="carousel-caption">
                              '.$text2.'
              ...
              <div class="box box-solid bg-purple-gradient">
                ...
                <div class="box-body">
                  <div id="carousel-example-generic3" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" style="min-height: 150px;">
                    <?php
                     $row_recentnews_en1 = mysql_fetch_array($retval_recentnews_en1, MYSQL_ASSOC);
                      $text1 = $row_recentnews_en1['text4'];
                      $image1 = $row_recentnews_en1['image1']; 
                      echo '<div class="item active">
                            <img src="'.$image1.'" alt="'.$text1.'">
                            <div class="carousel-caption">
                              '.$text1.'
                    ...
                    <?php while($row_recentnews_en = mysql_fetch_array($retval_recentnews_en, MYSQL_ASSOC)){
                      $text2 = $row_recentnews_en['text1'];
                      $image2 = $row_recentnews_en['image1']; 
                      echo '<div class="item">
                            <img src="'.$image2.'" alt="'.$text2.'">
                            <div class="carousel-caption">
                              '.$text2.'
                ...
                <div class="box-body">
                  <div id="carousel-example-generic1" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" style="min-height: 150px;">
                     ...
                     $row_recentproducts_en1 = mysql_fetch_array($retval_recentproducts_en1, MYSQL_ASSOC);
                      $text1 = $row_recentproducts_en1['text4'];
                      $image1 = $row_recentproducts_en1['image1']; 
                      echo '<div class="item active">
                            <img src="'.$image1.'" alt="'.$text1.'">
                            <div class="carousel-caption">
                              '.$text1.'
                    ...
                    <?php while($row_recentproducts_en = mysql_fetch_array($retval_recentproducts_en, MYSQL_ASSOC)){
                      $text2 = $row_recentproducts_en['text4'];
                      $image2 = $row_recentproducts_en['image1']; 
                      echo '<div class="item">
                            <img src="'.$image2.'" alt="'.$text2.'">
                            <div class="carousel-caption">
                              '.$text2.'
...
*/
          ...
          <div class="row">
            <form method="POST" action="/Admin/Promo">
              <div class="col-md-12">
                    <div class="form-group" style="float: left; margin-left: 0%; width: 100%;">
                        <label>New Promo</label>
                        <div class="input-group">
                        <div class="input-group-addon">
                          <i class="fa fa-pencil text-yellow"></i>
                        </div>
                        <input class="form-control" type="text" name="promo_text" placeholder="New Promo" style="height: 50px;">
                        <div class="input-group-addon">
                          <button name="promo_submit" type="submit" class="form-control btn btn-success"><i class="fa fa-save"></i></button>
                        </div>
                      </div><!-- /.input group -->                       
                      </div>

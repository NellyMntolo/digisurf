...
include '../Model/shop_new_packageDAO.php';
?>
        ...
        <div class="modal">
              <div class="modal-inset" style="">
                  ...
                  <div class="modal-body">
                      ...
                      <button type="submit" class="btn-success loadin" name="create_project_submit">Submit</button>                      
                      <p class="ps"></p>
                  </div>
              </div>
          </div>
            ...
            <div class="col-md-12">
              <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                  ...
                  <li class="active"><a class="text-blue" href="#general" data-toggle="tab">General</a></li>
                ...
                <div class="tab-content" style="min-height: 300px;">
                  ...
                  <div class="tab-pane active" id="general">  
                      ...
                      <div class="box-body text-blue">
                        ...
                        <div class="form-group">
                          <label>Add Products to This Package(optional)</label>
                        ...
                        <div class="form-group">
                          ...
                          <input required type="text" id="" name="content_text2" class="form-control" value="" placeholder="00.0">
                              ...
                              <div class="form-group">
                                ...
                                <input required type="text" id="" name="content_text22" class="form-control" value="" placeholder="00">
                              </div><!-- /.input group -->                       
                              </div>

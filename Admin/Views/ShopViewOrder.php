...
include '../Model/shop_view_orderDAO.php';
?>
...
<li><a href="/Admin/articleCategories"><i class="fa fa-clone"></i><span>Article Categories</span></a></li>   
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Order <?php echo $order_number;?> from <?php echo $customer_first_name;?> <?php echo $customer_last_name;?>
            ...
            <div class="col-md-6">
              <div class="box box-solid bg-teal-gradient">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title box-upper"> Order <small class="label label-default bg-teal"><?php echo $order_number;?></small> </h3>
                  <div class="box-tools pull-right" data-toggle="tooltip" title="Print Order">
                      <div class="btn-group" data-toggle="btn-toggle" >
                        <button type="button" onclick="window.print();" class="btn-default bg-teal" style=""><i class="fa fa-print"></i> Print</button>
                      </div>
                    </div>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <dl class="dl-horizontal">
                    <dt>WARNING:</dt>
                    <dd>"Delivered" option is irreversible. Calculations will begin right away.</dd>
                    <dt>Change Status</dt> <!-- AJAX order Status -->
                    <dd><form id="status_select_form">
                    <select class="selectpicker" id="status_select" name="order_status">
                      <?php echo $current_order_status;?>
                    </select><input type="hidden" value="<?php echo $order_id;?>" name="order_id"></form><div id="ok"></div></dd>
                    <dt>Order Date</dt>
            ...
            <div class="col-md-6">
              <div class="box box-solid bg-teal-gradient">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title box-upper"> Customer <small class="label label-default bg-teal"><?php echo $customer_first_name;?> <?php echo $customer_last_name;?></small></h3>
                  <div class="box-tools pull-right" data-toggle="tooltip" title="View Customer">
                      <div class="btn-group" data-toggle="btn-toggle" >
                        <button type="button" onclick="window.location='/Admin/ViewCustomer/<?php echo $customer_url;?>'" class="btn-default bg-teal" style=""><i class="fa fa-eye"></i> View</button>
                      </div>
                    </div>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <dl class="dl-horizontal">
                    <dt>Email</dt>
                    <dd><a href="mailto:<?php echo $customer_email;?>"><?php echo $customer_email;?></a></dd>
                    <dt>Account Registered On</dt>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-solid">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title box-upper"> Products | <small class="label label-default bg-teal"><?php echo $total_orders_products;?></small> </h3>
                </div><!-- /.box-header -->
                <div class="box-body text-teal">
                        ...
                        <dl class="dl-horizontal">
                          <dt>Products</dt>
                          <dd>$<?php echo $all_products_total;?></dd>
                          <dt>Discounts</dt>
                          <dd>-<?php echo $product_discount;?></dd>
                          <dt>Shipping fee</dt>
                          <dd>+$<?php echo $product_shipping;?></dd>
                          <dt>Total</dt>
                          <dd>$<?php echo $order_price;?></dd>
                        </dl>
                </div><!-- /.box-body -->
...
$("#status_select").on('change', function(e) {
  $("#status_select_form").submit();


});

$("#status_select_form").submit(function(dd) {
  dd.preventDefault();
  $("#LoadingImage").show();
  //var order_status = $("#status_select").val();
  var order_status = $("#status_select_form :input").serialize();
  $.ajax({
                    type: "POST",
                    ...
                    //alert("done ");
                    //$("#ok").html(response);
                    setTimeout(function(){ $("#LoadingImage").hide(); $("#ok").html(response); }, 2000);
                    setTimeout(function(){ $("#ok").html(''); }, 3000);
                    },            

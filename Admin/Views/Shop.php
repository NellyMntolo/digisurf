                ...
                <div class="tab-content" style="min-height: 300px;">
                  ...
                  <div class="tab-pane active" id="products">
                      <div class="box-header">                        
                          ...
                          <button class="pull-right btn btn-success save-btn" title="New Product" data-widget="collapse" style="margin-right: 10px;"><i class="fa fa-plus"></i></button>
                      </div><!-- /.box-header -->
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                          ...
                          <tbody>
                            <tr class="color-palette text-center">
                              ...
                              <td>enabled</td>
                              <td><form method="get" action=""><button type="submit" class="btn btn-primary btn-flat" title="Edit"><i class="fa fa-pencil"></i></button><input type="hidden" name="" value="$avail_idx"></form></td>
                            </tr>

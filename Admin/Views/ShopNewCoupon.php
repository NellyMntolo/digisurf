        ...
        <div class="modal">
              <div class="modal-inset" style="">
                  ...
                  <div class="modal-body">
                      ...
                      <button type="submit" class="btn-success loadin" name="create_coupon_submit">Submit</button>                      
                      <p class="ps"></p>
                  </div>
              </div>
          </div>
            ...
            <div class="box box-solid <?php echo $bgGradient;?>">
                      ...
                      <div class="box-body text-black">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="" name="content_text1" class="form-control" value="" placeholder="Coupon Name">
                              </div><!-- /.input group -->                       
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" id="" name="content_text2" class="form-control" value="" placeholder="Coupon Code/Number">
                              </div><!-- /.input group -->                       
                              </div>
                              ...
                              <div class="form-group with-border">
                                ...
                                <input type="text" id="" name="content_text3" class="form-control" value="" placeholder="Coupon Discount">
                              </div><!-- /.input group -->                       
                              </div>
                              ...
                              <div class="form-group with-border">
                                ...
                                <input type="text" id="reservationtime" name="content_text4" class="form-control" value="" placeholder="YYYY/MM/DD h:m - YYYY/MM/DD h:m">
                              </div><!-- /.input group -->                       
                              </div>
                              ...
                              <!--<div class="form-group with-border">
                                ...
                                <input type="text" id="" name="content_text6" class="form-control" value="" placeholder="Coupon URL">
                              </div>                       
                              </div>--> 

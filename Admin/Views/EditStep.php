          ...
          <div class="box box-solid">
            ...
            <div class="box-body pad">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="location_entext1" class="form-control" placeholder="Step Title" value="<?php echo $entext1; ?>">
                    </div><!-- /.input group -->                       
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="location_entext2" placeholder="Step Description"><?php echo $entext2; ?></textarea>
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                        <input type="submit" name="edit_location" value="Save" class="form-control btn-success" style="width: 50%;">
                    </div>

                    <div class="form-group">
                        <input type="submit" name="delete_location" value="Delete Step" class="form-control btn-danger" style="width: 50%;">
                    </div>

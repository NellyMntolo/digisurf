...
include '../Model/shop_all_ordersDAO.php';
?>
            ...
            <div class="col-md-12">
                <div class="box box-solid">
                      <div class="box-header width-border">                        
                          <h3 class="box-title">Total Notifications | <small class="label label-default"><?php echo $total_order_notifications;?></small> </h3>
                          <button class="pull-right btn btn-primary" data-widget="collapse" title="Minimize"><i class="fa fa-minus"></i></button>
                          ...
                          <!--<button class="pull-right btn btn-success" title="New Order"  style="margin-right: 10px;" onclick="window.location='/Admin/NewOrder/';"><i class="fa fa-plus"></i></button>-->
                      </div><!-- /.box-header -->
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                          ...
                          <tbody>
                            <?php echo $all_order_notifications;?>
                          </tbody>
                        </table>
                </div><!-- /.box-body -->
              </div><!-- /.box -->

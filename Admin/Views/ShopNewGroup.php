              ...
              <div class="box box-solid">
                ...
                <div class="box-body">
                        <div class="form-group">
                          ...
                          <input required type="text" id="" name="content_text1" class="form-control" value="" placeholder="Type here">
                        </div><!-- /.input group -->                       
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <input required type="text" id="" name="content_text2" class="form-control" value="" placeholder="00.0">
                        </div><!-- /.input group -->                       
                        </div>

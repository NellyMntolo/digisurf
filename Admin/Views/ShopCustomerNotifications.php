                ...
                <div class="tab-content" style="min-height: 300px;">
                  ...
                  <div class="tab-pane active" id="customers">
                      <div class="box-header text-teal">                        
                          <i class="fa fa-user-secret"></i><h3 class="box-title"> Customer List | <small class="label label-default"><?php echo $total_customer_notification;?></small> </h3>
                          <!--<button class="pull-right btn btn-danger" title="Delete Selected"><i class="fa fa-trash"></i></button>-->
                          <!--<a class="pull-right btn btn-info" title="Print" style="margin-right: 10px;" href="/Admin/AllCustomers_Print/" target="_blank"><i class="fa fa-print"></i></a>-->
                      ...
                      <div class="box-body text-teal">
                        <table id="example1" class="table table-bordered table-hover">
                          ...
                          <tbody>
                          <?php echo $all_customer_notifications; ?>
                          </tbody>
                        </table>
                      </div><!--box-body-->

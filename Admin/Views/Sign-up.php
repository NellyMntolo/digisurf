...
<form action="/Admin/AllSign-up" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
<!-- MODAL -->
...
<!-- MODAL -->
        ...
        <!-- General Settings -->
          ...
          <div class="box box-solid">
            ...
            <div class="box-body pad">   
                    ...
                    <div class="form-group" style="width: 95%;">
                      ...
                      <input type="file" name="log-in_image1">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="general_entext4" class="form-control" value="<?php echo $entext4;?>" placeholder="Main Slogan">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext1" class="form-control" value="<?php echo $entext5;?>" placeholder="Text 1">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext2" class="form-control" value="<?php echo $entext6;?>" placeholder="Text 2">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext3" class="form-control" value="<?php echo $entext7;?>" placeholder="Text 3">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext4" class="form-control" value="<?php echo $entext8;?>" placeholder="Text 4">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext5" class="form-control" value="<?php echo $entext9;?>" placeholder="Text 5">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext6" class="form-control" value="<?php echo $entext10;?>" placeholder="Text 6">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext7" class="form-control" value="<?php echo $entext11;?>" placeholder="Text 7">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext8" class="form-control" value="<?php echo $entext12;?>" placeholder="Text 8">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext9" class="form-control" value="<?php echo $entext13;?>" placeholder="Text 9">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext10" class="form-control" value="<?php echo $entext14;?>" placeholder="Text 10">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext11" class="form-control" value="<?php echo $entext15;?>" placeholder="Text 11">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext12" class="form-control" value="<?php echo $entext16;?>" placeholder="Text 12">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext13" class="form-control" value="<?php echo $entext17;?>" placeholder="Text 13">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext14" class="form-control" value="<?php echo $entext18;?>" placeholder="Text 14">
                    </div><!-- /.input group -->                         
                    </div>
          ...
          <div class="box box-solid">
            <div class="box-header">
              <h3 class="box-title">Phone Code Settings --No Function Yet</h3>
                  <div class="pull-right box-tools">
                    <button class="btn btn-default btn-sm" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                    <!--<button class="btn btn-info btn-sm" data-widget="remove" data-toggle="tooltip" title="Remove"><i class="fa fa-times"></i></button>-->
                  </div><!-- /. tools -->
            ...
            <div class="box-body pad">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext15" class="form-control" value="<?php echo $entext19;?>" placeholder="Text 1">
                    </div><!-- /.input group -->                       
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="content_entext16" placeholder="Text 2"><?php echo $entext20;?></textarea>
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="content_entext17" placeholder="text 3"><?php echo $entext21;?></textarea>
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="content_entext18" placeholder="text 4"><?php echo $entext22;?></textarea>
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="content_entext19" placeholder="text 5"><?php echo $entext23;?></textarea>
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="content_entext20" placeholder="text 6"><?php echo $entext24;?></textarea>
                    </div><!-- /.input group -->                      
                    </div>

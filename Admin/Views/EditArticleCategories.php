...
include '../Model/editarticle_categoryDAO.php';
?>
...
<li class="active"><a href="/Admin/articleCategories" style="color:white;"><i class="fa fa-clone text-lime"></i><span>Article Categories</span></a></li>   
              </ul>
            </li>

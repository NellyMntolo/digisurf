...
include '../Model/event_categoriesDAO.php';
            ...
            <div class="col-md-12">
                <div class="box box-solid">
                      <div class="box-header width-border">                        
                          ...
                          <button class="pull-right btn btn-success" title="New Category"  style="margin-right: 10px;" onclick="window.location='/Admin/NeweventCategory/';"><i class="fa fa-plus"></i></button>
                      </div><!-- /.box-header -->
                    <div class="box-body">

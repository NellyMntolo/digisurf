...
include '../Model/shop_edit_couponDAO.php';
?>
...
<form action="/Admin/AllShopCoupons" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
<input type="hidden" value="<?php echo $idx;?>" name="coupon_id">
      <!-- MODAL -->
                  ...
                  <div class="modal-body">
                      ...
                      <div class="btn-cover-wrap">
                            <div class="btn-back">
                              ...
                              <button class="yes" type="button" ><input type="submit" value="Yes" name="delete_coupon_submit" class="btn loadin" > </button>
                              <button class="no" type="button">No</button>
                            </div>
                            <div class="btn-front">Delete</div>
                      </div>
                      <button type="submit" class="btn-success loadin" name="edit_coupon_submit">Confirm Changes</button>                      
                      <p class="ps"></p>
                  </div>
              </div>
          </div>
            ...
            <div class="box box-solid <?php echo $bgGradient;?>">
                      ...
                      <div class="box-body text-black">
                            ...
                            <div class="form-group" style="width: 90%;">
                              ...
                              <input type="file" name="coupon_image1">
                              <img src="<?php echo $coupons_image;?>">
                            </div>
                            
                            <div class="form-group">
                                <label><font color="red">*</font>Coupon Name:</label>
                                <div class="input-group">
                                <div class="input-group-addon">
                                  <i class="fa fa-pencil-square-o text-black faa-wrench animated faa-slow"></i>
                                </div>
                                <input type="text" id="" name="content_text1" class="form-control" value="<?php echo $coupons_name ;?>" placeholder="Coupon Name">
                              </div><!-- /.input group -->                       
                              </div>

                              <div class="form-group">
                                <label><font color="red">*</font>Coupon Code/Number:</label>
                                <div class="input-group">
                                <div class="input-group-addon">
                                  <i class="fa fa-barcode text-black faa-wrench animated faa-slow"></i>
                                </div>
                                <input type="text" id="" name="content_text2" class="form-control" value="<?php echo $coupons_code ;?>" placeholder="Coupon Code/Number">
                              </div><!-- /.input group -->                       
                              </div>


                              <div class="form-group with-border">
                                <label><font color="red">*</font>Coupon Discount:</label>
                                <div class="input-group">
                                <div class="input-group-addon">
                                  <i class="fa fa-dollar text-black faa-wrench animated faa-slow"></i>
                                </div>
                                <input type="text" id="" name="content_text3" class="form-control" value="<?php echo $coupons_discount ;?>" placeholder="Coupon Discount">
                              </div><!-- /.input group -->                       
                              </div>

                              <div class="form-group with-border">
                                <label><font color="red">*</font>Coupon Starting & Ending Dates:</label>
                                <div class="input-group">
                                <div class="input-group-addon">
                                  <i class="fa fa-calendar text-black faa-wrench animated faa-slow"></i>
                                </div>
                                <input type="text" id="reservationtime" name="content_text4" class="form-control" value="<?php echo $coupons_start_date.' - '.$coupons_end_date ;?>" placeholder="YYYY/MM/DD h:m - YYYY/MM/DD h:m">
                              </div><!-- /.input group -->                       
                              </div>

                              
                              <div class="form-group">
                                <label>Coupon Status (visible/invisible):</label>
                                <div class="input-group">
                              ...
                              <div class="form-group with-border">
                                <label><font color="red">*</font>Coupon URL: The following characters are forbidden: !<;>;?=+#"°{}_$%&/\.</label>
                                <div class="input-group">
                                <div class="input-group-addon">
                                  <i class="fa fa-dollar text-black faa-wrench animated faa-slow"></i>
                                </div>
                                <input type="text" id="" name="content_text6" class="form-control" value="<?php echo $coupons_url ;?>" placeholder="Coupon URL">
                              </div><!-- /.input group -->                       
                              </div>

...
include '../Model/shop_view_customerDAO.php';
?>
...
<li><a href="/Admin/articleCategories"><i class="fa fa-clone"></i><span>Article Categories</span></a></li>   
            ...
            <li class="active"><a href="/Admin/AllCustomers/" style="color:white;"><i class="fa fa-group text-lime"></i>Customers</a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Information About Customer: <?php echo $customer_first_name[0];?>. <?php echo $customer_last_name;?>
            ...
            <div class="col-md-6">
              <div class="box box-solid">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title box-upper"> <?php echo $customer_first_name;?> <?php echo $customer_last_name;?> </h3>
                    <div class="box-tools pull-right" data-toggle="tooltip" title="Status">
                      <div class="btn-group" data-toggle="btn-toggle" >
                        <button type="button" onclick="window.location='/Admin/EditCustomer/<?php echo $customer_url;?>';" class="btn-default" style="height: 25px;"><i class="fa fa-pencil-square-o"></i> Edit</button>
                      </div>
                    </div>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <dl class="dl-horizontal">
                    <dt>Member ID</dt>
                    <dd><?php echo $customer_member_id;?></dd>
                    <dt>Gender</dt>                    
                    <dd><?php echo $customer_gender;?></dd>
                    <dt>Email</dt>
                    <dd><?php echo $customer_email;?></dd>
                    <!-- <dt>DOB</dt> -->
                    <!-- <dd><?php echo $customer_dob;?></dd> -->
                    <dt>Registration Date</dt>
                    <dd><?php echo $customer_reg_date;?></dd>
                    <dt>Last Profile Update</dt>
                    <dd><?php echo $customer_last_update;?></dd>
                    <dt>City</dt>
                    <dd><?php echo $address_city;?></dd>
                    <dt>Country</dt>
                    <dd><?php echo $address_country;?></dd>
                    <dt>Landline</dt>
                    <dd><?php echo $address_landline;?></dd>
                    <dt>Mobile</dt>
                    <dd><?php echo $address_mobile;?></dd>
                    <!-- <dt>Shipping Address</dt> -->
                    <!-- <dd><?php echo $address_one;?></dd> -->
                    <!-- <dt>Sponsor</dt> -->
                    <!-- <dd><?php echo $customer_sponsor;?></dd> -->
                    <!-- <dt>Discount Type</dt> -->
                    <!-- <dd><?php echo $customer_discount;?>%</dd> -->
                    <!-- <dt>Member Type</dt> -->
                    <!-- <dd><?php echo $c_type;?></dd> -->
                    <!-- <dt>Total Accumulated Points</dt> -->
                    <!-- <dd><?php echo $customer_points;?></dd> -->
                  </dl>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
...
<?php /*
              <div class="box box-solid">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title box-upper"> Order History | <small class="label label-default"><?php echo $order_total;?></small> </h3>
                </div><!-- /.box-header -->
                <div class="box-body">
              ...
              <div class="box box-solid">
                <div class="box-header with-border">
                  <i class="fa fa-eye"></i>
                  <h3 class="box-title box-upper"> Viewed Products | <small class="label label-default">1</small> </h3>
                </div><!-- /.box-header -->
                <div class="box-body">
            ...
            <?php /*
              <div class="box box-solid">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title box-upper"> Discount History | <small class="label label-default"><?php echo $discount_total;?></small> </h3>
                </div><!-- /.box-header -->
                <div class="box-body">
              ...
              <div class="box box-solid">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title box-upper"> Bonus History | <small class="label label-default"><?php echo $bonus_total;?></small> </h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-hover">
                          <thead>
              ...
              <div class="box box-solid">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title box-upper"> Store Credit | <small class="label label-default"><?php echo $storage_total;?></small> </h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-hover">
                          <thead>
...
*/ ?>
              ...
              <div class="box box-solid">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title box-upper"> Login History</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-solid">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title box-upper"> Addresses | <small class="label label-default">1</small> </h3>
                  <div class="box-tools pull-right" data-toggle="tooltip" title="Status">
                      <div class="btn-group" data-toggle="btn-toggle" >
                        <button type="button" onclick="window.location='/Admin/EditCustomer/<?php echo $customer_url;?>';" class="btn-default" style="height: 25px;"><i class="fa fa-pencil-square-o"></i> Edit</button>
                      </div>
                  ...
                  <table id="example6" class="table table-bordered table-hover">
                          ...
                          <tbody>
                            <tr class="color-palette text-center">
                              ...
                              <td><?php echo $address_country;?></td>
                              <td><?php echo $address_one;?></td>
                              <td><?php echo $address_two;?></td>
                              <td><?php echo $address_three;?></td>
                              <td><?php echo $address_landline;?></td>
            ...
            <div class="col-md-8">
              <div class="box box-solid">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title box-upper"> Reviews | <small class="label label-default">1</small> </h3>
            ...
            <div class="col-md-4">
              <div class="box box-solid">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title box-upper"> Groups | <small class="label label-default">1</small> </h3>
                  <div class="box-tools pull-right" data-toggle="tooltip" title="Status">
                      <div class="btn-group" data-toggle="btn-toggle" >
                        <button type="button" onclick="window.location='/Admin/EditCustomer/<?php echo $customer_url;?>';" class="btn-default" style="height: 25px;"><i class="fa fa-pencil-square-o"></i> Edit</button>
                      </div>
                ...
                <div class="box-body">
                  <table id="example5" class="table table-bordered table-hover">
                          ...
                          <tbody>
                            <tr class="color-palette text-center">
                              <td><a href="/Admin/ViewGroup/<?php echo $member_group_url;?>"><?php echo $member_group_name;?></a></td>
                              <td><?php echo $member_group_start_date;?></td>
                              <td><?php echo $total_group_members;?></td>
                              <?php echo $final_groupt_totals;?>
                            </tr>
                          </tbody>
                        </table>
                </div><!-- /.box-body -->

      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                <span class="info-box-icon bg-red"><i class="fa ion-ios-calendar"></i></span>
                <div class="info-box-content">
                  <span class="info-box-text">This Month</span>
                  <span class="info-box-number">11<?php //echo $publishedblogs_projects; ?><!--/--><?php //echo $totalblogs_projects; ?></span>
                </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
            </div><!-- /.col -->
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number">5<?php //echo $published_projects; ?><!--/--><?php //echo $total_projects; ?></span>
                </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
            </div><!-- /.col -->
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number">2<?php //echo $views;?></span>
                </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
            </div><!-- /.col -->
          </div><!-- /.row -->
                        ...
                        <table id="example1" class="table table-bordered table-hover">
                          ...
                          <tbody>
                            <tr class="color-palette text-center">
                              <td><i class="fa fa-users text-aqua"></td>
                              <td>google glass</td>
                              <td>61000</td>
                              <td>$21.22</td>
                              <td><span class="label label-info">999</span></td>
                              <td>enabled</td>
                              <td><form method="get" action=""><button type="button" class="btn btn-danger btn-flat" title="Delete"><i class="fa fa-trash"></i></button><input type="hidden" name="" value="$avail_idx"></form></td>
                            </tr>
...
$("#option1").change(function() {
    if(this.checked) {
      ...
      $("#option2").iCheck("check");
      $(".fa", "#option2").removeClass("fa-square-o").addClass('fa-check-square-o');
    }
});
*/
...
$("#new_product").click( function(event) {
        if($('#prod_name').val() == ''){
                $('#prod_name').css("border", "2px solid red");
                $('#prod_name').focus();
                return false;
            }

...
include '../Model/editfirstsliderDAO.php';
          ...
          <div class="box box-solid">
            ...
            <div class="box-body pad">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="location_entext1" class="form-control" placeholder="Slider Title" value="<?php echo $entext1; ?>">
                    </div><!-- /.input group -->                       
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="location_entext2" class="form-control" placeholder="Slider Description" value="<?php echo $entext2; ?>">
                    </div><!-- /.input group -->                       
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="location_entext3" class="form-control" placeholder="Button Text" value="<?php echo $entext3; ?>">
                    </div><!-- /.input group -->                       
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="location_entext4" class="form-control" placeholder="Button Link" value="<?php echo $entext4; ?>">
                    </div><!-- /.input group -->                       
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="location_entext5" class="form-control" placeholder="Button Text" value="<?php echo $entext5; ?>">
                    </div><!-- /.input group -->                       
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="location_entext6" class="form-control" placeholder="Button Link" value="<?php echo $entext6; ?>">
                    </div><!-- /.input group -->                       
                    </div>
                    ...
                    <div class="form-group">
                        <input type="submit" name="edit_first_slider" value="Save" class="form-control btn-success" style="width: 50%;">
                    </div>

                    <div class="form-group">
                        <input type="submit" name="delete_first_slider" value="Delete Slider" class="form-control btn-danger" style="width: 50%;">
                    </div>
...
<input type="hidden" value="<?php echo $idx; ?>" name="first_slider_id">
          </form>

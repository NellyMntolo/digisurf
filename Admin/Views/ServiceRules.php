...
include '../Model/servicerulesDAO.php';
...
<form action="/Admin/AllServiceRules" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
<!-- MODAL -->
        ...
        <!-- General Settings -->
          <div class="box box-solid">
            <div class="box-header">
              <h3 class="box-title">Service Rules Settings</h3>
            ...
            <div class="box-body pad">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="general_entext2" placeholder="Slogan 1"><?php echo $entext2; ?></textarea>
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="general_entext3" placeholder="Slogan 2"><?php echo $entext3; ?></textarea>
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group" style="width: 95%; margin-left: 2%;">
                      ...
                      <textarea class="form-control" id="faq" rows="3" name="content_entext1" placeholder="Content"><?php echo $entext4; ?></textarea>
                    </div><!-- /.input group -->                       
                    </div>          
                  ...
                  <?php echo "<script>CKEDITOR.instances.faq.setData('".mysql_real_escape_string($entext4, $conn)."')</script>"; ?>

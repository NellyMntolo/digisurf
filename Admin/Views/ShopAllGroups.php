            ...
            <div class="col-md-12">
                <div class="box box-solid">
                      <div class="box-header width-border">                        
                          <h3 class="box-title">Group List | <small class="label label-default"><?php echo $total_groups;?></small> </h3>
                          ...
                          <button class="pull-right btn btn-success" title="New Group"  style="margin-right: 10px;" onclick="window.location='/Admin/NewGroup/';"><i class="fa fa-plus"></i></button>
                      </div><!-- /.box-header -->
                    <div class="box-body">

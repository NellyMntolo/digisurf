        ...
        <div class="modal">
              <div class="modal-inset" style="">
                  ...
                  <div class="modal-body">
                      ...
                      <button type="submit" class="btn-success" name="create_product_submit">Submit</button>                      
                      <p class="ps"></p>
                  </div>
              </div>
          </div>
            ...
            <div class="col-md-12">
              <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                  ...
                  <li><a class="text-aqua" href="#pricing" data-toggle="tab">Pricing</a></li>
                </ul>
                        ...
                        <div class="form-group" style="width: 95%;">
                          ...
                          <input type="file" name="product_image1">
                            ...
                            <div class="form-group">
                                ...
                                <input required type="text" id="prod_name" name="content_text1" class="form-control" value="" placeholder="Product Name">
                              </div><!-- /.input group -->                       
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" id="" name="content_text2" class="form-control" value="" placeholder="SKU (Stock Keeping Unit)">
                              </div><!-- /.input group -->                       
                              </div>
                              ...
                              <div class="form-group with-border">
                                ...
                                <input type="text" id="" name="content_text3" class="form-control" value="" placeholder="Barcode(UPC, EAN, JAN, ISBN, MPN, etc.)">
                              </div><!-- /.input group -->                       
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <input type="checkbox" style="opacity: 0;" id="content_text4" name="content_text4" class="form-control" data-on-color="success" data-off-color="danger" checked value="Y">
                              </div><!-- /.input group -->                       
                              </div>
...
<?php /*
                              ...
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                <div class="input-group-addon">
                                  <i class="fa fa-dollar text-teal faa-wrench animated faa-slow"></i>
                                </div>
                                <input type="text" id="" name="content_text5" class="form-control" value="" placeholder="0.00">
                              </div><!-- /.input group -->                       
                              </div>
...
*/ ?>
                              <div class="form-group">
                                ...
                                <input required type="text" id="" name="content_text6" class="form-control" value="" placeholder="000">
                              </div><!-- /.input group -->                       
                              </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" style="width: 100%;" data-role="tagsinput" name="content_text8" class="form-control mytagsinput" value=""> 
                  ...
                  <div class="tab-pane" id="pricing">  
                      ...
                      <div class="box-body text-aqua">
                              ...
                              <div class="form-group">
                                ...
                                <input required type="text" id="" name="content_text5" class="form-control" value="" placeholder="00">
                              </div><!-- /.input group -->                       
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <input required type="text" id="" name="content_text25" class="form-control" value="" placeholder="00">
                              </div><!-- /.input group -->                       
                              </div>

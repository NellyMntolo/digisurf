...
include '../Model/shop_all_productsDAO.php';
?>
                ...
                <div class="tab-content" style="min-height: 300px;">
                  ...
                  <div class="tab-pane active" id="products">
                      <div class="box-header">                        
                          ...
                          <button class="pull-right btn btn-success" title="New Product" style="margin-right: 10px;"  onclick="window.location='/Admin/NewProduct/';"><i class="fa fa-plus"></i></button>
                      </div><!-- /.box-header -->
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                          ...
                          <tbody id="sorters">
                           <!-- <tr class="color-palette text-center product-list">
                              ...
                              <td>enabled</td>
                              <td><form method="get" action=""><button type="button" onclick="window.location='/Admin/ViewProduct';" class="btn btn-primary btn-flat" title="Edit"><i class="fa fa-pencil"></i></button><input type="hidden" name="" ></form></td>
                            </tr>
                            ...
                            <tr class="color-palette text-center product-list">
                              ...
                              <td><span class="label label-info">999</span></td>
                              <td>enabled</td>
                              <td><form method="get" action=""><button type="button" class="btn btn-primary btn-flat" title="Edit"><i class="fa fa-pencil"></i></button><input type="hidden" name="" ></form></td>
                            </tr>-->
                  ...
                  <div class="tab-pane" id="packages">  
                      ...
                      <div class="box-header">
                          ...
                          <button class="pull-right btn btn-success" onclick="window.location='/Admin/NewPackage/';" title="New Package" style="margin-right: 10px;"><i class="fa fa-plus"></i></button>                        
                      </div><!-- /.box-header -->

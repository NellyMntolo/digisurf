          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview menu-open active">
              ...
              <ul class="treeview-menu menu-open">
                <li class="active"><a href="/Admin/AddWorkshop" style="color:white;"><i class="fa fa-keyboard-o text-lime"></i>Create A Workshop</a></li>
          ...
          <div class="box box-solid">
            ...
            <div class="box-body pad">                  
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="datepicker" name="general_entext4" class="form-control" placeholder="Date">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input id="entitle" type="text" name="content_entext1" class="form-control" placeholder="Page Main Slogan">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea rows="3" name="content_entext2" class="form-control" placeholder="Description 1"></textarea>
                    </div><!-- /.input group -->                         
                    </div>

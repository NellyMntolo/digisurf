...
<li><a href="/Admin/articleCategories"><i class="fa fa-clone"></i><span>Article Categories</span></a></li>   
            ...
            <li class="active" style="color:white;"><a href="/Admin/Footer/"><i class="fa fa-wheelchair text-lime"></i><span>Footer</span></a></li>
...
<!-- MODAL -->
          ...
          <div class="box box-solid">
            ...
            <div class="box-body pad"> 
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="content_text3" placeholder="Footer Address"><?php echo $entext3; ?></textarea>
                    </div><!-- /.input group -->
                    </div>

                    <div class="form-group">
                      <label>Footer Company: </label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-phone"></i>
                      </div>
                      <input type="tel" name="content_text1" class="form-control" value="<?php echo $entext1; ?>" placeholder="Page Footer Company">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_text2" class="form-control" value="<?php echo $entext2; ?>" placeholder="Page Footer Legal">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="content_text4" placeholder="Page Footer Description"><?php echo $entext4; ?></textarea>
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_text5" class="form-control" value="<?php echo $entext5; ?>" placeholder="Footer Top ">
                    </div><!-- /.input group -->                      
                    </div> 
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_text6" class="form-control" value="<?php echo $entext6; ?>" placeholder="Footer Text">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_text7" class="form-control" value="<?php echo $entext7; ?>" placeholder="Footer Text">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_text8" class="form-control" value="<?php echo $entext8; ?>" placeholder="Footer Text">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_text9" class="form-control" value="<?php echo $entext9; ?>" placeholder="Footer Text">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_text10" class="form-control" value="<?php echo $entext10; ?>" placeholder="Footer Text">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_text11" class="form-control" value="<?php echo $entext11; ?>" placeholder="Footer Text">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_text12" class="form-control" value="<?php echo $entext12; ?>" placeholder="Footer Text">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_text13" class="form-control" value="<?php echo $entext13; ?>" placeholder="Footer Text">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_text14" class="form-control" value="<?php echo $entext14; ?>" placeholder="Footer Text">
                    </div><!-- /.input group -->                      
                    </div>

                    <!--<div class="form-group">
                      <button type="button" class="save-btn extra-btn" style="position: relative;right: auto; margin-top: auto;height: auto;width: auto;" ><i class="fa fa-save"></i></button>
                    </div> -->       
          ...
          <div class="box box-solid">
            ...
            <div class="box-body pad">    
<form action="/Admin/AllFooter" method="POST" enctype="multipart/form-data" accept-charset="utf-8" style="border: 1px dotted black; margin-bottom: 30px;">
            <div class="row">

            <div class="box-header" style="padding-left: 50px;">
              <h3 class="box-title"> Add new</h3>
            </div><!-- /.box-header -->

                    <div class="col-lg-4 form-group" style="width: 29%; float: left; margin-left:2%;">
                    ...
                    <div class="col-lg-4 form-group" style="width: 90%; float: left;  margin-left:2%;">
                      <button class="btn-success extra-btn" type="submit" value="Add Item" name="add_social"><i class="fa fa-save"></i></button>
                    </div>
            </div>
</form>
                    ...
                    echo '<form action="/Admin/AllFooter" method="POST" enctype="multipart/form-data" accept-charset="utf-8" style="border: 1px dotted black;">
                    <div class="row" >
                            <div class="form-group" style="width: 29%; float: left; margin-left:2%;">
                              <input type="file"  name="social_image">
                            ...
                            <div class="form-group" style="width: 90%; float: left; margin-left:2%;">
                              <button class="btn-success extra-btn" type="submit" value="Edit Item" name="edit_social"><i class="fa fa-save"></i></button>
                              <button class="btn-danger extra-btn" type="submit" value="Delete Item" name="delete_social"><i class="fa fa-trash"></i></button>
                            </div>
                      </div>
                            </form>';

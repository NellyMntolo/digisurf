...
include '../Model/shop_edit_currencyDAO.php';
?>
                  ...
                  <div class="modal-body">
                      ...
                      <div class="btn-cover-wrap">
                            <div class="btn-back">
                              ...
                              <button class="yes" type="button" ><input type="submit" value="Yes" name="delete_currency_submit" class="btn loadin" > </button>
                              <button class="no" type="button">No</button>
                            </div>
                            <div class="btn-front">Delete</div>
                      </div>
                      <button type="submit" class="btn-success loadin" name="edit_currency_submit">Confirm Changes</button>                      
                      <p class="ps"></p>
                  </div>
              </div>
          </div>
            ...
            <div class="box box-solid <?php echo $bgGradient;?>">
                      ...
                      <div class="box-body text-aqua">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="prod_name" name="content_text1" class="form-control" value="<?php echo $currency_name;?>" placeholder="Currency Name">
                              </div><!-- /.input group -->                       
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" id="" name="content_text2" class="form-control" value="<?php echo $currency_iso_code;?>" placeholder="ISO Code">
                              </div><!-- /.input group -->                       
                              </div>
                              ...
                              <div class="form-group with-border">
                                ...
                                <input type="text" id="" name="content_text3" class="form-control" value="<?php echo $currency_iso_num;?>" placeholder="ISO Number">
                              </div><!-- /.input group -->                       
                              </div>
                              ...
                              <div class="form-group with-border">
                                ...
                                <input type="text" id="" name="content_text4" class="form-control" value="<?php echo $currency_sign;?>" placeholder="Symbol">
                              </div><!-- /.input group -->                       
                              </div>

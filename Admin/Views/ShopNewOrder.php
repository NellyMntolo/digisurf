...
include '../Model/shop_new_orderDAO.php';
?>
        ...
        <div class="modal">
              <div class="modal-inset" style="">
                  ...
                  <div class="modal-body">
                      ...
                      <button type="submit" class="btn-success" name="create_project_submit">Confirm</button>                      
                      <p class="ps"></p>
                  </div>
              </div>
          </div>
...
<!-- MODAL -->
            ...
            <div class="col-md-12">
              <div class="box box-solid">
                <div class="box-header with-border">
                  <i class="fa fa-tags"></i><h3 class="box-title box-upper"> Products </h3>
          ...
          <!--<div class="col-md-12">
            ...
            <div class="box box-solid">
            <div class="box-header with-border">
                  <i class="fa fa-tags"></i><h3 class="box-title box-upper"> Items In Cart </h3>
                        <div class="pull-right box-tools">
                          <button class="btn btn-default btn-sm" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          <!--<button class="btn btn-info btn-sm" data-widget="remove" data-toggle="tooltip" title="Remove"><i class="fa fa-times"></i></button>-->
                        </div><!-- /. tools -->
                ...
                <div class="box-body" style="min-height: 300px;">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                          ...
                          <tbody id="content_return">
                          <?php //echo $all_products;?>
                          <!-- <tr class="color-palette text-center product-list">
                              <td><img src="/Admin/Assets/img/glass.jpg"></td>
                              <td>google glass</td>
                              <td>61000</td>
                              <td>$21.22</td>
                              <td><span class="label label-info">999</span></td>
                              <td><button type="button" class="btn btn-danger btn-flat" title="Edit"><i class="fa fa-trash"></i></button></td>
                            </tr>
                            ...
                            <tr class="color-palette text-center product-list">
                              ...
                              <td>google glass</td>
                              <td>61000</td>
                              <td><span style="text-decoration: line-through;" class="label bg-maroon">$21.22</span> <br>$15.99 </td>
                              <td><span class="label label-info">999</span></td>
                              <td><button type="button" class="btn btn-danger btn-flat" title="Edit"><i class="fa fa-trash"></i></button></td>
                            </tr> -->
                          </tbody>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="box box-solid">
                <div class="box-header with-border">
                  <i class="fa fa-group"></i><h3 class="box-title box-upper"> Customers </h3>
                        <div class="pull-right box-tools">
                          <button class="btn btn-default btn-sm" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          <!--<button class="btn btn-info btn-sm" data-widget="remove" data-toggle="tooltip" title="Remove"><i class="fa fa-times"></i></button>-->
                        </div><!-- /. tools -->
                ...
                <dl class="dl-horizontal">
                    <dt>Select Customer</dt> <!-- AJAX order Status -->
                    <dd><form id="status_select_form">
                    <select class="selectpicker" id="status_select" name="current_customer">
                    <option value="0">Select</option>
                      <?php echo $all_customers;?>
                    </select></form><div id="ok"></div></dd>
                    <dt>Customer ID</dt>
                    <dd><div class="customer_member_id"></div></dd>
                    <dt>Customer Email</dt>
                    <dd><div class="customer_email"></div></dd>
                    <!-- <dt>Total PP</dt>
                    <dd>100</dd> -->
                    <dt>CheckOut</dt>
                    <dd><li><button title="Save All" data-tiggle="tooltip" type="button" class="extra-btn btn-success saver"><i class="fa fa-save"></i></button></li></dd>
                  </dl>
...
<script src="/Admin/Assets/js/hover_side1.js"></script>
    ...
    $('.selectpicker').change(function () {
      // body...
      $(".bootstrap-select .dropdown-toggle").removeClass (function (index, css) {
          return (css.match (/\bbg-\S+/g) || []).join(' ');
      });
     var theclass = $('.selectpicker option:selected').attr('class');
     $(".bootstrap-select .dropdown-toggle").addClass(theclass);
    });
...
$(document).ready(function() {
  ...
  $('#popupDelete').click(function () {
    ...
    $(".cart_item_button").click( function(event) {
        ...
        //console.log($(this).parents('form:first').serialize());         
             ...
             var data = $(this).parents('form:first').serialize();
                              $.ajax({
                                  ...
                                  //alert("yes");
                                  $('#content_return').append(response);
                                  //console.log(data);
                                  },            
    ...
    //}
        ...
        $(".cart_items_Form").submit( function() { 
          return false;
        });
...
// $('#example1 tbody').on( 'click', 'button.btn-flat', function () {
...
$("#status_select_form").submit(function(dd) {
  ...
  $.ajax({
                    type: "POST",
                    url:"/Admin/BackCartCustomer",
                    data: order_status,
                    dataType: 'json',
                    success: function (response) {
                    //console.log(response.a);
                    
                    setTimeout(function(){ $("#LoadingImage").hide(); }, 2000);
                    setTimeout(function(){ $('.customer_member_id').html(response.a); $('.customer_email').html(response.b); }, 3000);
                    },            
                    error: function (jXHR, textStatus, errorThrown) {
                       alert(errorThrown);               
                    }

...
include '../Model/shop_all_couponsDAO.php';
?>
...
<li><a href="/Admin/articleCategories"><i class="fa fa-clone"></i><span>Article Categories</span></a></li>   
            ...
            <div class="col-md-12">
                <div class="box box-solid">
                      ...
                      <div class="box-header">                        
                          ...
                          <button onclick="window.location='/Admin/NewCoupon';" class="pull-right btn btn-success" title="New Coupon" style="margin-right: 10px;"><i class="fa fa-plus"></i></button>
                      </div><!-- /.box-header -->

                  <div class="box-body" id="coupons">
    ...
    $(function () {
        ...
        $('#coupons input[type="checkbox"]').iCheck({
        ...
        $(".checkbox-toggle").click(function () {
          ...
          if (clicks) {
            ...
            $("#coupons input[type='checkbox']").iCheck("uncheck");
            $(".fa", this).removeClass("fa-check-square-o").addClass('fa-square-o');
          } else {
            //Check all checkboxes
            $("#coupons input[type='checkbox']").iCheck("check");

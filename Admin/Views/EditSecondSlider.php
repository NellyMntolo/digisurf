...
include '../Model/editsecondsliderDAO.php';
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview menu-open active">
              <a href="#"><i class="fa fa-laptop"></i> <span>Manage Pages</span> <i class="fa fa-angle-left pull-right text-lime"></i></a>
              <ul class="treeview-menu menu-open">
                <li class="active"><a href="/Admin/Main/" style="color:white;"><i class="fa fa-edit"></i>Index</a></li>
          ...
          <div class="box box-solid">
            ...
            <div class="box-body pad">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="location_entext2" class="form-control" placeholder="Slider Button" value="<?php echo $entext2; ?>">
                    </div><!-- /.input group -->                       
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="location_entext3" class="form-control" placeholder="Button Link" value="<?php echo $entext3; ?>">
                    </div><!-- /.input group -->                       
                    </div>

                    <div class="form-group" style="width: 95%;">
                      <label>Slider Image (1920X600px)</label>
                    ...
                    <div class="form-group">
                        <input type="submit" name="edit_second_slider" value="Save" class="form-control btn-success" style="width: 50%;">
                    </div>

                    <div class="form-group">
                        <input type="submit" name="delete_second_slider" value="Delete Slider" class="form-control btn-danger" style="width: 50%;">
                    </div>
...
<input type="hidden" value="<?php echo $idx; ?>" name="second_slider_id">
          </form>

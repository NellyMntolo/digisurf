          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview menu-open active">
              ...
              <ul class="treeview-menu menu-open">
                <li class="active"><a href="/Admin/Addevent" style="color:white;"><i class="fa fa-keyboard-o text-lime"></i>Create Events</a></li>
        ...
        <form id="categ-form">
          ...
          <div class="box box-solid">
            <div class="box-header">
              <h3 class="box-title">Category Settings</h3>
            ...
            <div class="box-body pad">
                    ...
                    <input style="height: 40px; opacity: 0;" type="text" id="zh_catag" name="" class="form-control" placeholder="Category ZH" readonly>                                    
          ...
          <div class="box box-solid">
            ...
            <div class="box-body pad">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="general_entext1" class="form-control" placeholder="Page Title">
                    </div><!-- /.input group -->                       
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="general_entext2" placeholder="Page Keywords"></textarea>
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="general_entext3" placeholder="Page Description"></textarea>
                    </div><!-- /.input group -->                      
                    </div>
            ...
            <div class="box-body pad">                  
                   ...
                   <div class="form-group" style="width: 95%;">
                    ...
                    <div class="form-group">
                      ...
                      <input id="entitle" type="text" name="content_entext1" class="form-control"  placeholder="Event Title">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea rows="3" id="entitle" name="content_entext2" class="form-control"  placeholder="Event Short Description"></textarea>
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <hr class="hrs">
                     ...
                     <div class="form-group" style="width: 95%; margin-left: 2%;">
                      ...
                      <textarea class="form-control" id="faq" rows="3" name="content_entext3" placeholder="Event Content"></textarea>
                    </div><!-- /.input group -->                       
                    </div>         

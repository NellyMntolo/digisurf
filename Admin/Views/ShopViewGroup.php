...
include '../Model/shop_view_groupDAO.php';
?>
        ...
        <div class="modal">
              <div class="modal-inset" style="">
                  ...
                  <div class="modal-body">
                      ...
                      <button type="submit" class="btn-danger loadin" name="delete_project_submit">Delete Group</button>                      
                      <p class="ps"></p>
                  </div>
              </div>
          </div>
            ...
            <div class="col-md-6">
              <div class="box box-solid <?php echo $bgGradient;?>">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title box-upper"> Group Information </h3>
                    <div class="box-tools pull-right" data-toggle="tooltip" title="Edit/Delete">
                      <div class="btn-group" data-toggle="btn-toggle" >
                        <button type="button" onclick="window.location='/Admin/EditGroup/<?php echo $group_url;?>';" class="btn-default <?php echo $bgColor;?>" style=""><i class="fa fa-pencil-square-o"></i> Edit</button>
                        <button type="button" class="btn-flat btn-danger save-btn" style=""><i class="fa fa-trash"></i> Delete Group</button>
                      </div>
                    </div>
                </div><!-- /.box-header -->
            ...
            <div class="col-md-12">
              ...
              <div class="box box-solid">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title box-upper"> Members | <small class="label label-default <?php echo $bgColor;?>"><?php echo $total_members;?></small> </h3>
                </div><!-- /.box-header -->

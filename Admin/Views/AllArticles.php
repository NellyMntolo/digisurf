            ...
            <div id="sorter" class="box-body pad">
                    <?php while($rowprojecten = mysql_fetch_array($retvalprojecten, MYSQL_ASSOC)){
                      ...
                      $idx = $rowprojecten['idx'];
                              ...
                              echo "<div id=\"blogList_$idx\" class=\"project-list\">";
                              echo "<form action=\"/Admin/EditArticles\" method=\"GET\" enctype=\"multipart/form-data\" accept-charset=\"utf-8\">";
                              echo '<img src="'.$rowprojecten['image1'].'"/>';
                              echo "<input type=\"hidden\" value=\"$idx\" name=\"blog_id\">";

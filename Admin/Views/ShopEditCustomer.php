...
include '../Model/shop_edit_customersDAO.php';
?>
...
<li><a href="/Admin/articleCategories"><i class="fa fa-clone"></i><span>Article Categories</span></a></li>   
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Edit Customer: <?php echo $customer_first_name;?> <?php echo $customer_last_name;?>
        ...
        <div class="modal">
              <div class="modal-inset" style="">
                  ...
                  <div class="modal-body">
                      ...
                      <button type="submit" class="btn-success" name="edit_project_submit">Submit</button>                      
                      <p class="ps"></p>
                  </div>
              </div>
          </div>
                    ...
                    <div class="box box-solid">
                      ...
                      <div class="box-body text-blue">
                        ...
                        <div class="form-group">
                          ...
                          <input required type="text" name="content_text2" class="form-control" value="<?php echo $customer_first_name;?>" placeholder="Type here">
                        </div><!-- /.input group -->                       
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <input required type="text" name="content_text3" class="form-control" value="<?php echo $customer_last_name;?>" placeholder="Type here">
                        </div><!-- /.input group -->                       
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <input required type="email" name="content_text4" class="form-control" value="<?php echo $customer_email;?>" placeholder="Type here" readonly>
                        </div><!-- /.input group -->                       
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <input required type="password" id="password" name="content_text5" class="login-field login-field-password form-control" placeholder="Password" value="<?php echo $customer_password;?>">
                        </div><!-- /.input group -->                       
                        </div>
...
<?php /*
                        <div class="form-group">
                          ...
                          <input required type="text" name="content_text6" class="datepicker form-control" value="<?php echo $customer_dob;?>">
                        </div><!-- /.input group -->                       
                        </div>

                        <div class="form-group">
                          <label><font color="red">*</font> Change Group: <small><?php echo $member_group_name;?></small></label>
                          <div class="input-group">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="content_text17" value="<?php echo $customer_sponsor;?>" class="form-control">
                        </div><!-- /.input group -->                       
                        </div>
*/ ?>
                       </div><!-- box-body-->
                    ...
                    <div class="box box-solid">
                      ...
                      <div class="box-body text-blue">
                        ...
                        <div class="form-group">
                          ...
                          <input required type="text" name="content_text8" class="form-control" value="<?php echo $address_city;?>" placeholder="Type here">
                        </div><!-- /.input group -->                       
                        </div>

                        <div class="form-group">
                          <label><font color="red">*</font> Country: <small><?php echo $address_country;?></small></label>
                          <div class="input-group">
                          <div class="input-group-addon" style="height: 40px;">
                        ...
                        <div class="form-group">
                          ...
                          <input required type="text" name="content_text10" class="form-control" value="<?php echo $address_one;?>" placeholder="Type here">
                        </div><!-- /.input group -->                       
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <input required type="text" name="content_text11" class="form-control" value="<?php echo $address_two;?>" placeholder="Type here">
                        </div><!-- /.input group -->                       
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <input required type="text" name="content_text12" class="form-control" value="<?php echo $address_three;?>" placeholder="Type here">
                        </div><!-- /.input group -->                       
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <input required type="text" name="content_text13" class="form-control" value="<?php echo $address_landline;?>">
                        </div><!-- /.input group -->                       
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <input required type="text" name="content_text14" class="form-control" value="<?php echo $address_mobile;?>">
                        </div><!-- /.input group -->                       
                        </div>

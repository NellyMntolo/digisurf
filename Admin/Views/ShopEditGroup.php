...
include '../Model/shop_edit_groupDAO.php';
?>
...
<li><a href="/Admin/articleCategories"><i class="fa fa-clone"></i><span>Article Categories</span></a></li>   
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Edit Group: <?php echo $group_name;?>
...
<form action="/Admin/AllShopGroup" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
...
<!-- MODAL -->
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="box box-solid">
                <div class="box-header with-border">
                  <i class="fa fa-group"></i><h3 class="box-title box-upper"> Edit Information </h3>
                        <div class="pull-right box-tools">
                          <button class="btn btn-default btn-sm" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          <!--<button class="btn btn-info btn-sm" data-widget="remove" data-toggle="tooltip" title="Remove"><i class="fa fa-times"></i></button>-->
                        </div><!-- /. tools -->
                  </div>
                <div class="box-body <?php echo $bgText;?>">
                        <div class="form-group">
                          ...
                          <input required type="text" id="" name="content_text1" class="form-control" placeholder="Type here" value="<?php echo $group_name;?>">
                        </div><!-- /.input group -->                       
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                          <div class="input-group-addon">
                            <i class="fa fa-percent text-blue faa-wrench animated faa-slow"></i>
                          </div>
                          <input required type="text" id="" name="content_text2" class="form-control" placeholder="00.0" value="<?php echo $group_discount;?>">
                        </div><!-- /.input group -->                       
                        </div>

                        <div class="form-group">
                          <label><font color="red">*</font> Group Theme:</label>
                          <div class="input-group">
                          <div class="input-group-addon" style="height: 40px;">
                            <i class="fa fa-object-group text-blue faa-wrench animated faa-slow"></i>
                          </div>
                          <select required type="text" name="content_text3" class="selectpicker form-control" data-width="90%">
                              <option value="1" class="bg-teal">1</option>
                              <option value="2" class="bg-aqua">2</option>
                              <option value="3" class="bg-light-blue">3</option>
                              <option value="4" class="bg-navy">4</option>
            ...
            <div class="box box-solid <?php echo $bgGradient;?>">
                <div class="box-header with-border">
                  <i class="fa fa-group"></i><h3 class="box-title box-upper"> Group Information </h3>
                        <div class="pull-right box-tools">
                          <button class="btn btn-default btn-sm" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                          <!--<button class="btn btn-info btn-sm" data-widget="remove" data-toggle="tooltip" title="Remove"><i class="fa fa-times"></i></button>-->
                        </div><!-- /. tools -->
                ...
                <div class="box-body">
                        <dl class="dl-horizontal">
                          ...
                          <dt>Discount</dt>
                          <dd><?php echo $group_discount; ?>%</dd>
                          <dt>Total No. Of Members</dt>
                          <dd><?php echo $total_members; ?></dd>
                          <dt>Creation Date</dt>
                          <dd><?php echo $group_start_date; ?></dd>
                          <dt>Last Updated On</dt>
                          <dd><?php echo $group_update_date; ?></dd>
                        </dl>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
            </div><!-- ./col -->

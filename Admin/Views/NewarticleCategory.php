...
<form action="/Admin/AllArticleCategories" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
        ...
        <div class="modal">
              <div class="modal-inset" style="">
                  ...
                  <div class="modal-body">
                      ...
                      <button type="submit" class="btn-success loadin" name="new_category_submit">Submit</button>                      
                      <p class="ps"></p>
                  </div>
              </div>
          </div>

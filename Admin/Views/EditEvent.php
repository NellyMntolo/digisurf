...
include '../Model/editeventDAO.php';
              ...
              <li><button title="Save All" data-tiggle="tooltip" type="button" class="extra-btn btn-success save-btn" style="float: right; right: 0;"><i class="fa fa-save"></i></button></li>
                <li class="dropdown" >
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <?php echo $case_group_active_language; ?>
                  </ul>
                </li>
              </ul>
            </div><!-- /.navbar-collapse -->
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="/Admin/Events/"><i class="fa fa-edit"></i>Events</a></li>
            ...
            <li class="treeview menu-open active">
              ...
              <ul class="treeview-menu menu-open">
                ...
                <li class="active"><a href="/Admin/ViewAllEvents/" style="color:white;"><i class="fa fa-tv text-lime"></i>View All Events<span class="label label-primary pull-right"><?php echo $allprojects_idx; ?></span></a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="/Admin/AddArticles"><i class="fa fa-keyboard-o"></i>Create News</a></li>
...
<!-- General Settings -->
          <div class="box box-solid">
            <div class="box-header">
              <h3 class="box-title">Event Category Settings</h3>
            ...
            <div class="box-body pad">
                <form id="categ-form-1" method="post">
                    ...
                    <div class="input-group">                      
                      <select class="selectpicker" name="selected_option" id="form-select-1">
                          ...
                          <option value="0">Add Events Category</option>
                          <option value="<?php echo $idx; ?>">Remove Events Category</option>
                        <?php //echo $categories; ?>                 
                      </select>
                      </div><!-- /.input group -->  
                    </div>
                ...
                <form id="categ-form-2" method="POST" action="/Admin/AllEvents">
                    <div class="form-group" id="action">
                    <label>Add Or Remove Events Category</label>
                    <div class="input-group">   
          ...
          <div class="box box-solid">
            <div class="box-header with-border">
              <h3 class="box-title">Categories Containing This Event</h3>
                  <div class="pull-right box-tools">
                    <button class="btn btn-default btn-sm" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                    <!--<button class="btn btn-info btn-sm" data-widget="remove" data-toggle="tooltip" title="Remove"><i class="fa fa-times"></i></button>-->
                  </div><!-- /. tools -->
      ...
      <div class="modal-frame1">
        <div class="modal1">
              ...
              Please select images to delete
                  ...
                  <form action="/Admin/AllEvents" method="POST">
        
                  <div class="modal-body1">
                      <div class="">
                          <div style="position: relative; float: left; width: 210px; margin-top: 10px; height: 150px;" class="check-image-cover">
...
<form id="allform" action="/Admin/AllEvents" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
<!-- MODAL -->
          ...
          <div class="box box-solid">
            ...
            <div class="box-body pad">                  
                   ...
                   <div class="form-group" style="width: 95%;">
                      ...
                      <input type="file" name="case_image1">
                    ...
                    <div class="form-group">
                      ...
                      <input id="entitle" type="text" name="content_entext1" class="form-control" value="<?php echo $entext4; ?>"  placeholder="Events Title">
                    </div><!-- /.input group -->                      
                    </div>

                    <div class="form-group">
                      <label>Events Short Description</label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-pencil-square-o text-lime faa-wrench animated faa-slow"></i>
                      </div>
                      <textarea rows="3" id="entitle" name="content_entext2" class="form-control"  placeholder="Events Short Description"><?php echo $entext5; ?></textarea>
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group" style="width: 95%; margin-left: 2%;">
                      ...
                      <textarea class="form-control" id="faq" rows="3" name="content_entext3" placeholder="Event Content"><?php echo $entext6; ?></textarea>
                    </div><!-- /.input group -->                       
                    </div>          
                  ...
                  <?php echo "<script>CKEDITOR.instances.faq.setData('".mysql_real_escape_string($entext6, $conn)."')</script>"; ?>

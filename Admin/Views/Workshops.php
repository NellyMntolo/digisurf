          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview menu-open active">
              ...
              <ul class="treeview-menu menu-open">
                ...
                <li class="active"><a href="/Admin/Workshops/" style="color:white;"><i class="fa fa-edit text-lime"></i>Workshops</a></li>
...
<form action="/Admin/AllWorkshops/" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
<!-- MODAL -->
          ...
          <div class="box box-solid">
            ...
            <div class="box-body pad">    
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="general_entext4" class="form-control" value="<?php echo $entext4;?>" placeholder="Main Title">
                    </div><!-- /.input group -->                         
                    </div>

...
include '../Model/shop_all_currencyDAO.php';
?>
            ...
            <div class="col-md-12">
              <!--<div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                  ...
                  <li class="active"><a href="#products" data-toggle="tab">Currencies</a></li>
                </ul>
                <div class="tab-content" style="min-height: 300px;">

                  <div class="tab-pane active" id="products">-->
                  <div class="box box-solid" id="products">
                      <div class="box-header">                        
                          ...
                          <button class="pull-right btn btn-success" title="New Currency" style="margin-right: 10px;"  onclick="window.location='/Admin/NewCurrency/';"><i class="fa fa-plus"></i></button>
                      </div><!-- /.box-header -->

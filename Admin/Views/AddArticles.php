          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview menu-open active">
              ...
              <ul class="treeview-menu menu-open">
                <li class="active"><a href="/Admin/AddArticles" style="color:white;"><i class="fa fa-keyboard-o text-lime"></i>Create An Article</a></li>
...
<input type="hidden" id="selected_tag_en" name="selected_tag_en" class="form-control" placeholder="" readonly>
<input type="hidden" id="selected_tag_zh" name="selected_tag_zh" class="form-control" placeholder="" readonly>
            ...
            <div class="box-body pad">                  
                   ...
                   <div class="form-group" style="width: 95%;">
                    ...
                    <div class="form-group">
                      ...
                      <input id="entitle" type="text" name="content_entext1" class="form-control"  placeholder="Featured Article Title">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea rows="3" name="content_entext2" class="form-control"  placeholder="Short Description"></textarea>
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group" style="width: 95%; margin-left: 2%;">
                      ...
                      <textarea class="form-control" id="article_content" rows="3" name="content_entext3" placeholder="Article Content"></textarea>
                    </div><!-- /.input group -->                       
                    </div>         
...
$("#tag-form").submit(function(event){
    ...
    $("#tag_id").val($("#form-select").val());
    $("#selected_tag_en").val($("#form-select :selected").text()); 
});
...
function submitForm(){
   var name = $("#form-select").val();
    ...
    $.ajax({
            ...
            //async: false,
            url:"/fetch_tag",
            data: "selected_tag=" + name,
            //data: $(this).serialize(),
            //dataType:"json",
            success: function (response) {
            //alert(response);  
            $("#zh_tag").val(response);
            $("#selected_tag_zh").val(response);

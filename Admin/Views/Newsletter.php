...
include '../Model/newsletterDAO.php';
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview menu-open active">
              ...
              <ul class="treeview-menu menu-open">
                ...
                <li class="active"><a href="/Admin/Newsletter/" style="color:white;"><i class="fa fa-edit text-lime"></i>Newsletter</a></li>
              </ul>
            </li>
            <li class="treeview">
...
<form action="/Admin/AllNewsletter" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
<!-- MODAL -->
          ...
          <div class="box box-solid">
            ...
            <div class="box-body pad">
                    ...
                    <div class="form-group" style="width: 95%;">
                      ...
                      <input type="file" name="newsletter_image1">
                      <img src="<?php echo $enimage1; ?>">
                    </div>

                    <div class="form-group">
                      <label><font color="red">*</font> Newsletter Title</label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-keyboard-o text-aqua"></i>
                      </div>
                      <input class="form-control" type="text" name="newsletter_url" placeholder="Newsletter Title" value="<?php echo $entext3; ?>">
                    </div><!-- /.input group -->                      
                    </div>

                    <div class="form-group">
                      <label>Newsletter Slogan</label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-keyboard-o text-aqua"></i>
                      </div>
                      <input class="form-control" type="text" name="newsletter_slogan" placeholder="Newsletter Slogan" value="<?php echo $entext4; ?>">
                    </div><!-- /.input group -->                      
                    </div>
                  

                    <div class="form-group" style="width: 95%; margin-left: 2%;">
                      <label>Newletter info.</label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-pencil-square-o text-aqua"></i>
                      </div>
                      <textarea rows="5" name="newsletter_info" id="newsletter" class="form-control" placeholder="Newletter info."><?php echo $entext2; ?></textarea>
                    </div><!-- /.input group -->                       
                    </div>
                    ...
                    <?php echo "<script>CKEDITOR.instances.newsletter.setData('".mysql_real_escape_string($entext2, $conn)."')</script>"; ?>
...
<?php /*
          ...
          <div class="box box-solid">
            <div class="box-header">
              <h3 class="box-title">Current Newsletters</h3>
                  <div class="pull-right box-tools">
                    <button class="btn btn-default btn-sm" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                    <!--<button class="btn btn-info btn-sm" data-widget="remove" data-toggle="tooltip" title="Remove"><i class="fa fa-times"></i></button>-->
                  </div><!-- /. tools -->

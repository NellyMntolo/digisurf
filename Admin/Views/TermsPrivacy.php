...
<html>
  <head>
    ...
    <title>Nothing is Garbage</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="/Admin/Home/" class="logo">
          ...
          <span class="logo-lg"><b>Nothing is Garbage</b></span>
        </a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="/Admin/TermsPrivacy/" style="color:white;"><i class="fa fa-keyboard-o text-lime"></i><span>Terms</span></a></li>
...
<form action="/Admin/AllTermsPrivacy" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
<!-- MODAL -->
        ...
        <!-- General Settings -->
          <div class="box box-solid">
            <div class="box-header">
              <h3 class="box-title">Terms & Conditions General Settings</h3>
            ...
            <div class="box-body pad">
                    ...
                    <div class="form-group" style="width: 95%;">
                      <label>Banner</label>
                      <input type="file" name="terms_image1">
                    ...
                    <div class="form-group" style="width: 95%; margin-left: 2%;">
                      ...
                      <textarea class="form-control" id="news_text" rows="3" name="content_text2" placeholder="All Content"></textarea>
                    </div><!-- /.input group -->                       
                    </div>
            ...
            <?php echo "<script>CKEDITOR.instances.news_text.setData('".mysql_real_escape_string($entext2, $conn)."')</script>"; ?>
...
<?php /*
          ...
          <div class="box box-solid">
            <div class="box-header">
              <h3 class="box-title">Privacy General Settings</h3>
                  <div class="pull-right box-tools">
                    <button class="btn btn-default btn-sm" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                    <!--<button class="btn btn-info btn-sm" data-widget="remove" data-toggle="tooltip" title="Remove"><i class="fa fa-times"></i></button>-->
                  </div><!-- /. tools -->
            ...
            <div class="box-body pad">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_text3" class="form-control" value="<?php echo $entext3; ?>" placeholder="Page Title">
                    </div><!-- /.input group -->                       
                    </div>
                    ...
                    <div class="form-group" style="width: 95%;">
                      <label>Banner</label>
                      <input type="file" name="terms_image2">
                    ...
                    <div class="form-group" style="width: 95%; margin-left: 2%;">
                      ...
                      <textarea class="form-control" id="p" rows="3" name="content_text4" placeholder="All Content"></textarea>
                    </div><!-- /.input group -->                       
                    </div>
            ...
            <?php echo "<script>CKEDITOR.instances.p.setData('".mysql_real_escape_string($entext4, $conn)."')</script>"; ?>

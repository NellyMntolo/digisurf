...
<form action="/Admin/AllCategories" method="POST" enctype="multipart/form-data" accept-charset="utf-8">

          <!-- Content Settings -->
          <div class="box box-solid">
            <div class="box-header">
              <h3 class="box-title"> New Category Settings</h3>
            ...
            <div class="box-body pad">
                    ...
                    <div class="form-group" style="width: 95%;">
                      <label for="cat_image">Category Icon <span class="label text-red" style="font-size: 20px;">*</span></label>
                      <input id="cat_image" type="file" name="category_image1">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext1" class="form-control" placeholder="Add New Category">
                    </div><!-- /.input group -->                         
                    </div>

                    <button class="btn-success extra-btn loadin" type="submit" value="Add Category" name="add_category"><i class="fa fa-save"></i></button>
          ...
          <div class="box box-primary"><!--collapsed-box-->
            <div class="box-header">
              <h3 class="box-title"> Edit Category Settings</h3>
                  <div class="pull-right box-tools">
            ...
            <div class="box-body pad">                      
                    ...
                    <!-- Multi-language name   select __ onchange="this.form.submit()" -->
                    <div class="input-group input-group-lg">
                    <form id="categ-form" style="max-width: 250px;margin-bottom: 15px;">
                    ...
                    <form action="/Admin/AllCategories" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
                      ...
                      <input type="text" id="en_catag" class="form-control" name="content_entext2" placeholder="<?php echo $lang_result;?>" style="width: 30%;float: left;margin-right: 10px;"> 
                      
                      <div style="float: left;max-width: 250px;margin-top: -55px">
	                      <select class="selectpicker hidden" name="catag_lang" id="catag_lang" style="float: left;margin-right: 10px;">
	                        <option value="">Choose Translation</option>
	                        <?php echo $catag_lang; ?>
	                      </select>
	                      <input type="text" id="catag_langs" class="form-control" name="content_entext3" placeholder="" style="float: left;margin-right: 10px;margin-top: 15px;">
	                      <span id="lang-warning" style="color: red;">!important warning! leave empty if not adding a new translation</span>
                      </div>
                      
                      <input type="hidden" id="category_id" name="category_id">
                      <input type="hidden" id="category_group" name="category_group">
                        
                      <button class="btn-success extra-btn loadin" type="submit" value="Edit Category" name="edit_category"><i class="fa fa-save"></i></button>
                      <button class="btn-danger extra-btn loadin" type="submit" value="Delete Category" name="delete_category"><i class="fa fa-trash"></i></button>
                    </form>
                  </div><!-- /input-group -->
...
<?php /*
            ...
            <div class="col-md-4">
                <!-- Content Settings -->
                <div class="box box-primary bg-light-blue-gradient"><!--collapsed-box-->
                  <div class="box-header">
                    <h3 class="box-title">Drag To Change Order</h3>
                        <div class="pull-right box-tools">
                          <!--<button class="btn btn-primary btn-sm" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>-->
                          <!--<button class="btn btn-info btn-sm" data-widget="remove" data-toggle="tooltip" title="Remove"><i class="fa fa-times"></i></button>-->
                        </div><!-- /. tools -->
                  </div><!-- /.box-header -->
                  <div id="sorter" class="box-body">                      


                        
                         
                         while($rowcategory_order = mysql_fetch_array($retvalcategory_order, MYSQL_ASSOC)){
                        $idx = $rowcategory_order['idx']; 
                        $text1 = $rowcategory_order['text1'];  
                        
                          echo '<a class="btn btn-block btn-social btn-default project-list" id="projectLis_'.$idx.'" style="width: 100%; margin-left: 0%;cursor:move;">
...
<script type="text/javascript">
  $(function () {
    $(".names").click(function () {
      $("#en_catag").val($(this).text());
      //$("#zh_catag").val($(".names2").text());
...
$("#catag_lang").on('change', function(e) {
        $("#catag_langs").attr("placeholder", $("#catag_lang :selected").text());

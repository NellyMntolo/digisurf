...
/*
  ...
  */
  ...
  foreach ($array as $key => $value) {
    # code...
    $query = "UPDATE digisurf_product SET sortable_order = ".$x." where idx ='".$value."' ";
    mysql_query($query) or die (mysql_error());   
    $x ++;
  }
...
$result = '';
                    ...
                    while($rowprojecten = mysql_fetch_array($retvalprojecten, MYSQL_ASSOC)){
                      ...
                      $misc_id = $rowprojecten['misc_id'];
                              ...
                              $result .= "<form action=\"/Admin/EditProduct\" method=\"GET\" enctype=\"multipart/form-data\" accept-charset=\"utf-8\">";

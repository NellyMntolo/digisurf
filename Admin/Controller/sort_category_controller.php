...
$array = $_POST['projectLis'];
  ...
  foreach ($array as $key => $value) {
    # code...
    $query = "UPDATE digisurf_categories SET sortable_order = ".$x." WHERE idx = ". $value;
...
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
                        ...
                        $sqlprojecten = 'select * from digisurf_categories where code="'.$current_lang.'" ORDER BY sortable_order ASC';

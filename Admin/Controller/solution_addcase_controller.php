...
//if(isset($_POST['test-input'])){ 
  ...
  /*
    ...
    $sql_category = 'SELECT * FROM green_solution_en WHERE idx = "'.$selected_option.'" ';    
     ...
     if(! $retval_category )
     {
      ...
      if ($category1 != null || $category2 != null || $category3 != null || $category4 != null || $category5 != null || $category6 != null || $category7 != null || $category8 != null || $category9 != null || $category10 != null) {
          $sql_option_name = 'SELECT * FROM green_project_en WHERE text4 != "'.$category1.'" AND text4 != "'.$category2.'" AND text4 != "'.$category3.'" AND text4 != "'.$category4.'" AND text4 != "'.$category5.'" AND text4 != "'.$category6.'" AND text4 != "'.$category7.'" AND text4 != "'.$category8.'" AND text4 != "'.$category9.'" AND text4 != "'.$category10.'"';
          $retval_option_name = mysql_query( $sql_option_name, $conn );     
           ...
           while($rowoption = mysql_fetch_array($retval_option_name, MYSQL_ASSOC)) {
            $idx = $rowoption['idx'];  
            $text1 = $rowoption['text4'];       
            $text2 = $rowoption['misc_id'];
            $result .= '<option value="'.$text1.'">'.$text1.'</option>';
            }
      } else {
             $sql_option_name = 'SELECT * FROM green_project_en';    
             $retval_option_name = mysql_query( $sql_option_name, $conn );     
             if(! $retval_option_name )
             {
                die('Could not get data: ' . mysql_error());
     ...
     */
      ...
      $sql_misc = 'SELECT * FROM digisurf_solution WHERE idx = "'.$selected_option.'" ';    
     ...
     if(! $retval_misc )
     {
      ...
      //echo "<br>misc id = ".$text2;

      if ($misc_id != null) {
          $sql_option_name1 = 'SELECT * FROM digisurf_solution_list WHERE text1 != "'.$misc_id.'" and code ="'.$current_lang.'" ';
           ...
           while($rowoption1 = mysql_fetch_array($retval_option_name, MYSQL_ASSOC)){
                ...
                if (!empty($all_catagsnames)) {
                  ...
                  //foreach ($all_catagsnames as $key => $value) {
                      //$sql_catagnames = 'SELECT * FROM digisurf_project WHERE misc_id = "'.$value.'" and code ="'.$current_lang.'" ORDER BY misc_id ASC ';
                      $sql_catagnames = 'SELECT * FROM digisurf_project WHERE code ="'.$current_lang.'" ORDER BY misc_id ASC ';
                      ...
                      $text1 = $rowcatagnames['text4'];
                      $text2 = $rowcatagnames['misc_id'];
                      $result .= '<option value="'.$text2.'">1 '.$text1.'</option>';
                  ...
                  $sql_option_name2 = 'SELECT * FROM digisurf_solution_list WHERE code ="'.$current_lang.'" ';
                  $retval_option_name2 = mysql_query( $sql_option_name2, $conn );     
                   if(! $retval_option_name2 )
                   {
                    ...
                    //foreach ($all_catagsnames2 as $keys => $values) {
                      ...
                      //$sql_option_name_check = 'SELECT * FROM digisurf_project where misc_id != "'.$values.'" and code ="'.$current_lang.'" ORDER BY misc_id ASC'; 
                     $sql_option_name_check = 'SELECT * FROM digisurf_project WHERE misc_id NOT IN ('.implode($all_catagsnames2,',').')  and code ="'.$current_lang.'" ORDER BY misc_id ASC';    
                     ...
                     while($rowoption23 = mysql_fetch_array($retval_option_name1, MYSQL_ASSOC)){
                      $idx = $rowoption23['idx'];
                      $text1 = $rowoption23['text4'];
                      $text2 = $rowoption23['misc_id'];
                      $text3 [] = $rowoption23['misc_id'];
                      //echo "<br>".$text2;
                    ...
                    //}
                             ...
                             $sql_option_name3 = 'SELECT * FROM digisurf_project where code ="'.$current_lang.'" ORDER BY misc_id ASC';    
                             ...
                             while($rowoption3 = mysql_fetch_array($retval_option_name3, MYSQL_ASSOC)) {
                              $idx = $rowoption3['idx'];  
                              $text1 = $rowoption3['text4'];
                              $text2 = $rowoption3['misc_id'];
                              $result .= '<option value="'.$text2.'">else-- '.$text1.'</option>';
                     } 
                  }
                }
                 ...
                 while($rowoption3 = mysql_fetch_array($retval_option_name3, MYSQL_ASSOC)) {
                  ...
                  $text1 = $rowoption3['text4'];
                  $text2 = $rowoption3['misc_id'];
                  $result .= '<option value="'.$text2.'">3 '.$text1.'</option>';
         } 
      }

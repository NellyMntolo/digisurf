...
if(isset($_POST['page_submit'])){
 ...
 $sql="UPDATE digisurf_service_rules SET text1='".$entext1."', text2='".$entext2."', text3='".$entext3."', text4='".$entext4."' where code ='".$current_lang."' ";              
    ...
    //                    }
    // }
                       header("Refresh:0; url=/Admin/ServiceRules");
}

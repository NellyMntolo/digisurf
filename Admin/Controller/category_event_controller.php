...
if(isset($_POST['new_category_submit'])){
  ...
  // $sqla = 'INSERT INTO digisurf_categories (code, text1, text2, sortable_order, image1) VALUES ("'.$current_lang.'", "'.$entext1.'","'.$category_large.'"+1,"'.$large.'"+1, "'.$uploaded_image1.'")';            
...
if(isset($_POST['update_category_submit'])){
  ...
  $sql="UPDATE digisurf_categories SET text1='".$entext1."' WHERE text2='".$categoryid."' AND code='".$current_lang."' ";              
    ...
    //   $sql1="UPDATE digisurf_categories SET image1='".$filename."' WHERE text2 ='".$categoryid."' AND code='".$current_lang."'";
...
if(isset($_POST['delete_category'])){
  $categoryid = mysql_real_escape_string($_POST['category_id'],$conn);
        ...
        $sqlin = 'DELETE FROM digisurf_categories WHERE text2 ="'.$categoryid.'" ';

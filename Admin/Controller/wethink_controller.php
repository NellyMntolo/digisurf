...
if(isset($_POST['page_submit'])){
 ...
 $sql="UPDATE digisurf_news SET text1='".$entext1."', text2='".$entext2."', text3='".$entext3."', text4='".$entext4."' where code ='".$current_lang."' ";              
  ...
  if($image1 != null) {
      ...
      $sql1="UPDATE digisurf_news SET text5='".$filename."' where code ='".$current_lang."' ";

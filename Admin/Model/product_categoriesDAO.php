...
$current_lang = $_SESSION['lang'];
                        ...
                        $sqltag = 'select * from shop_digisurf_product_categories WHERE code="'.$current_lang.'" ORDER BY sortable_order ASC';
                        ...
                        $all_categories .= '<tr class="color-palette text-center product-list">
                                              ...
                                              <td>'.$category_name.'</td>
                                              <td>'.$lang_name.'</td>
                                              <td><button type="button" class="btn btn-primary btn-flat" onclick="window.location=\'/Admin/EditProductCategories/'.$category_idx.'\';"><i class="fa fa-edit"></i></button></td>
                                            </tr>';
                           }
                        ...
                        $sqltag_order = 'select * from shop_digisurf_product_categories WHERE code="'.$current_lang.'" ORDER BY sortable_order ASC';

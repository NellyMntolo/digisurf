...
$current_lang = $_SESSION['lang'];
                        ...
                        $sqlcategory = 'select * from digisurf_white_categories WHERE code="'.$current_lang.'" ORDER BY sortable_order ASC';
                        ...
                        $all_categories .= '<tr class="color-palette text-center product-list">
                                              ...
                                              <td>'.$category_name.'</td>
                                              <td>'.$lang_name.'</td>
                                              <td><button type="button" class="btn btn-primary btn-flat" onclick="window.location=\'/Admin/EditWhitePaperCategories/'.$category_idx.'\';"><i class="fa fa-edit"></i></button></td>
                                            </tr>'; 
                           }
                        


                        $sqlcategory_order = 'select * from digisurf_white_categories WHERE code="'.$current_lang.'" ORDER BY sortable_order ASC';

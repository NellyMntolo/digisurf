...
<body <?php body_class(); ?>>
	...
	//echo "mylanguage = ".$lang;
	$_SESSION['mywplang'] = $lang;
//
    echo $nav2;
    //echo $footer1;

// CUSTOM TABLE SELECT FOR WORDPRESS UI
$top_menu_query = "SELECT * FROM digisurf_menu where code='".$lang."'";
 $restaurants = $wpdb->get_row( $top_menu_query, ARRAY_A );

 //echo "the array res = ".$restaurants['text1'];

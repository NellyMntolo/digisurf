...
//if(isset($_POST['selected_category'])){ 
  ...
  $sql_catag_name = 'select * from green_product_zh  WHERE category1 = "'.$categoryname.'" OR category2 = "'.$categoryname.'" OR category3 = "'.$categoryname.'" OR category4 = "'.$categoryname.'" OR category5 = "'.$categoryname.'" OR category6 = "'.$categoryname.'" OR category7 = "'.$categoryname.'" OR category8 = "'.$categoryname.'" OR category9 = "'.$categoryname.'" OR category10 = "'.$categoryname.'" ORDER BY idx DESC';   
     ...
     if(! $retval_catag_name )
     {
      ...
      while($row_allproducts_en = mysql_fetch_array($retval_catag_name, MYSQL_ASSOC)){
    ...
    $url = $row_allproducts_en['url'];
        ...
        $result .= '<a href="/Products/Product/'.$url.'" class="all-item">

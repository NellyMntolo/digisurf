...
$_SESSION['lang'] = '';
    ...
    $sqlprojectzh = 'select * from digisurf_project WHERE idx="'.$id.'" LIMIT 1';
    ...
    $sqlprojecten = 'select * from digisurf_project WHERE sortable_order="'.$sortable_order.'" and code ="'.$language.'" LIMIT 1';
	...
	header("Refresh:0; url=/Case_Studies/projects/".urlencode($url)."");

...
$result1 .= '<div class="swiper-slide animated fadeInUp" style="width: 142.571px; margin-right: 7px;">';
$result2 .= '<div class="swiper-slide animated fadeInUp" style="width: 142.571px; margin-right: 7px;">';
$result3 .= '<div class="swiper-slide animated fadeInUp" style="width: 142.571px; margin-right: 7px;">';
$result4 .= '<div class="swiper-slide animated fadeInUp" style="width: 142.571px; margin-right: 7px;">';
$result5 .= '<div class="swiper-slide animated fadeInUp" style="width: 142.571px; margin-right: 7px;">';
$result6 .= '<div class="swiper-slide animated fadeInUp" style="width: 142.571px; margin-right: 7px;">';
$result0 .= '<div class="swiper-slide animated fadeInUp" style="width: 142.571px; margin-right: 7px;">';
$tc_Member = '';
...
// SET @MemberNo = '00014'; -- 會員編號
// SET @ClassNo = '0008'; -- 課程編號
// SET @BookingDate = '2017-09-26'; -- 預約日期

// $sqltest = 'SELECT tk_Guid, ts_Guid
// FROM tkticket
// LEFT OUTER JOIN tkticksales ON tk_Guid = ts_Parent
// WHERE tk_Member = @MemberNo
//   AND ts_BagDate <= @BookingDate
//     AND ts_ExpDate >= @BookingDate
...
// $retvaltest = mysql_query( $sqltest, $conn );                 
//       if(! $retvaltest )
//       {
//         die('Could not get data: ' . mysql_error());
//       }
...
//in_array($cc_Type, implode(array_unique($category_types_Short),','))
                        ...
                        //$sqlprojecten = $query;
$sqlprojecten = $query = 'SELECT * FROM tktimetable WHERE WEEKOFYEAR(tt_Date) = WEEKOFYEAR('.$week.') AND MONTH('.$week.')=MONTH('.$week.') AND tt_Teacher like "%D%" ORDER BY tt_Date ASC';
...
//bought classes
                        ...
                        $retvalwaiting_list = mysql_query( $sqlwaiting_list, $conn );                 
                          ...
                          //echo $cormemberNum.' == '.$tc_Member.'<br>';
...
//if ($tc_TimeTable_Guid == $tt_Guid) {echo $tc_TimeTable_Guid .' == '. $tt_Guid;}
                            ...
                            // tc_delete CHECK for Full classes
                        ...
                        if(getWeekday($test) == 4 && $i == 3){
                          ...
                          $result4 .=''.$link.'<div><!-- '.$tt_Guid.' --> <!-- '.$added_minutesbooking.' --> <!-- '.date('Y-m-d H:i:s').' -->
                                                    <p>'.$startting_time.'</p>
                                                    <p>'.$classtime.''.$classunit.'</p>
                                                    <p class="sport">'.$classname.'</p>
                                                    <p class="name">'.$memberName.'</p>

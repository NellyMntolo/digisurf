...
$_SESSION['lang'] = '';
	...
	$sqlprojectzh = 'select * from digisurf_solution WHERE idx="'.$id.'" LIMIT 1';
	...
	$sqlprojecten = 'select * from digisurf_solution WHERE misc_id="'.$misc_id.'" and code ="'.$language.'" LIMIT 1';
	...
	header("Refresh:0; url=/Solutions/Solution/".urlencode($url)."");

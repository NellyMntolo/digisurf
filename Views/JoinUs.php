...
<head>
    ...
    <script src="//s3-ap-northeast-1.amazonaws.com/justfont-user-script/jf-50988.js"></script>
...
<!-- Modal -->
<div class="modal fade joinus-modal" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        ...
        <div class="container cf">
            ...
            <section class="joinus-section">
                <div class="container">
                    ...
                    <form method="post" id="join_us_form">
                        <div class="row">
                            
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" id="join_us_name" name="join_us_name" class="form-control" placeholder="Name">                                    
                                </div>

                                <div class="form-group">
                                    <input type="text" id="join_us_phone_number" name="join_us_phone_number" class="form-control" placeholder="Phone Number">                                    
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <select id="join_us_volunteer_type" name="join_us_volunteer_type" class="form-control selectpicker exampleFormControlSelect1" id="">
                                      <option selected="selected">volunteer type</option>
                                      <option>shoes</option>
                                ...
                                <div class="form-group">
                                    <input type="email" id="join_us_volunteer_email" name="join_us_volunteer_email" class="form-control" placeholder="Email">                                    
                                </div>
                            </div>

                            <div class="col-md-12">
                                <div class="form-group">
                                    <textarea rows="3" id="join_us_volunteer_message" name="join_us_volunteer_message" class="form-control" placeholder="Why you want to join us?"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                              <div class="form-group">
                                <input type="text" id="joinus_code" name="joinus_code" class="form-control joinus-input" placeholder="Enter Code" required="required">
                                <p class="help-block text-danger"></p>
                              </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 ">
                                <div class="form-group join_us_submit">
                                    <input type="submit" id="join_us_submit" name="join_us_submit" class="form-control btn join_us_submit_btn" value="Submit">
                                </div> 
                            </div>
                        </div>

        ...
        <div class="container cf">
            ...
            <section class="joinus-section">
                <div class="container">
                    ...
                    <form id="cooperate_form" method="post">
                        <div class="row">
                            
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" id="cooperate_name" name="cooperate_name" class="form-control" placeholder="Name">                                    
                                </div>

                                <div class="form-group">
                                    <input type="tel" id="cooperate_phone_number" name="cooperate_phone_number" class="form-control" placeholder="Phone Number">                                    
                                </div>
                            </div>

                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" id="cooperate_company_name" name="cooperate_company_name" class="form-control" placeholder="Company Name">                                    
                                </div>
                                <div class="form-group">
                                    <input type="email" id="cooperate_email" name="cooperate_email" class="form-control" placeholder="Email">                                    
                                </div>
                            </div>

                            <div class="col-md-12">
                                <div class="form-group">
                                    <textarea rows="3" id="cooperate_message" name="cooperate_message" class="form-control" placeholder="I want to say ..."></textarea>                                    
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                              <div class="form-group">
                                <input type="text" id="cooperate_code" name="cooperate_code" class="form-control cooperate-input" placeholder="Enter Code" required="required">
                                <p class="help-block text-danger"></p>
                              </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 ">
                                <div class="form-group join_us_submit">
                                    <input type="submit" id="cooperate_submit" name="cooperate_submit" class="form-control btn join_us_submit_btn" value="Submit">
                                </div> 
                            </div>
                        </div>

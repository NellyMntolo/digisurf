...
<head>
    ...
    <meta name="description" content="<?php  echo $faq_text3;?>">
    <meta name="keywords" content="<?php  echo $faq_text2;?>">
    <meta name="author" content="2h">

<?php echo $favs;?>
<?php echo $css; ?>
    <title><?php  echo $faq_text1;?></title>
...
<!-- Modal -->
<div class="modal fade faq-modal" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-lg modal-vid" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" >
        ...
        <iframe type="text/html" width="100%" height="100%" src="<?php echo $faq_video_url;?>?autoplay=0&showinfo=0&controls=0&rel=0" frameborder="0" allowfullscreen></iframe>
      </div>
    </div>
  </div>
</div>
...
<main>
    <div class="main-container page-fix">
        <div class="container cf">
            ...
            <section class="faq-section-header" style="background-image: url('/assets/images/about.jpg');">
                <div class="container">
                  <div class="row">
                    <div class="col-md-12">
                      <h2>FAQs</h2>                 
            ...
            <!-- <section class="faq-section">
                <div class="container">
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <p>感謝您使用我們的產品和服務 (以下簡稱「服務」)。「服務」是由數位浪潮有限公司 Digisurf Co. Ltd., (以下簡稱「Digisurf」) 提供。</p><br><br>
                      <p>Digisurf非常重視會員的隱私權且遵循「個人資料保護法」之規定，因此制訂了隱私權保護政策，您可參考下列隱私權保護政策的內容。</p>
            ...
            <section class="faq-section">
                <div class="container">
                    <div class="col-md-6">
                        ...
                        <div class="tabs">
                          <div class="tab col-md-10">
                            <input type="radio" id="aboutus1" name="aboutus1">
                            <label class="tab-label" for="aboutus1">個人資料之安全</label>
                            <div class="tab-content">
                              保護會員的個人隱私是Digisurf重要的經營理念，在未經會員同意之下，我們絕不會將會員的個人資料提供予任何與網站服務無關之第三人。會員應妥善保密自己的網路密碼及個人資料，不要將任何個人資料，尤其是網路密碼提供給任何人。
                            </div>
                          </div>
                          <div class="tab col-md-10">
                            <input type="radio" id="aboutus2" name="aboutus1">
                            <label class="tab-label" for="aboutus2">個人資料的蒐集、處理、利用</label>
                            <div class="tab-content">
                              Digisurf相關網站所取得的個人資料，都僅供Digisurf於其內部、依照原來所說明的使用目的和範圍，除非事先說明、或依照相關法律規定，否則Digisurf不會將資料提供給第三人、或移作其他目的使用。
                            </div>
                          </div>
                          <!-- <div class="tab">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="tabs">
                          <div class="tab col-md-10">
                            <input type="radio" id="nominate1" name="nominate2">
                            <label class="tab-label" for="nominate1">Nominate</label>
                            <div class="tab-content">
                              保護會員的個人隱私是Digisurf重要的經營理念，在未經會員同意之下，我們絕不會將會員的個人資料提供予任何與網站服務無關之第三人。會員應妥善保密自己的網路密碼及個人資料，不要將任何個人資料，尤其是網路密碼提供給任何人。
                            </div>
                          </div>
                          <div class="tab col-md-10">
                            <input type="radio" id="nominate2" name="nominate2">
                            <label class="tab-label" for="nominate2">個人資料的蒐集、處理、利用</label>
                            <div class="tab-content">
                              Digisurf相關網站所取得的個人資料，都僅供Digisurf於其內部、依照原來所說明的使用目的和範圍，除非事先說明、或依照相關法律規定，否則Digisurf不會將資料提供給第三人、或移作其他目的使用。
                            </div>
                          </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="tabs">
                          <div class="tab col-md-10">
                            <input type="radio" id="members1" name="members1">
                            <label class="tab-label" for="members1">Members</label>
                            <div class="tab-content">
                              保護會員的個人隱私是Digisurf重要的經營理念，在未經會員同意之下，我們絕不會將會員的個人資料提供予任何與網站服務無關之第三人。會員應妥善保密自己的網路密碼及個人資料，不要將任何個人資料，尤其是網路密碼提供給任何人。
                            </div>
                          </div>
                          <div class="tab col-md-10">
                            <input type="radio" id="members2" name="members1">
                            <label class="tab-label" for="members2">個人資料的蒐集、處理、利用</label>
                            <div class="tab-content">
                              Digisurf相關網站所取得的個人資料，都僅供Digisurf於其內部、依照原來所說明的使用目的和範圍，除非事先說明、或依照相關法律規定，否則Digisurf不會將資料提供給第三人、或移作其他目的使用。
                            </div>
                          </div>

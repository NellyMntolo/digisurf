...
<head>
    ...
    <meta name="description" content="<?php  echo $history_text3;?>">
    <meta name="keywords" content="<?php  echo $history_text2;?>">
    <meta name="author" content="Nelly">

    <?php echo $favs;?>
    <?php echo $css; ?>
    <title><?php  echo $history_text1;?></title>
...
<!-- Modal -->
<div class="modal fade history-modal" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-lg modal-vid" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" >
        ...
        <!-- <iframe type="text/html" width="100%" height="100%" src="<?php echo $history_video_url;?>?autoplay=0&showinfo=0&controls=0&rel=0" frameborder="0" allowfullscreen></iframe> -->
      </div>
    </div>
  </div>
</div>
    ...
    <div class="main-container page-fix">
        <div class="container cf">
            ...
            <section class="history-section">
                <div class="container">
                  <div class="row history-title col-md-12">
                    <h1>History (72)</h1>
                  </div>
                </div>
            </section>
            ...
            <section class="history-section">
                <div class="container">
                  ...
                  <div class="row history-item col-md-6">
                    <div class="col-md-6">
                        <div class="col-md-1">
                          <img src="/assets/images/typewriter.jpg" class="store-image">
                        </div>
                        <div class="col-md-11">
                          <h2>Moska Studio</h2>
                          <div class="small-like"><img src="/assets/images/like.png"><span>12345</span></div>
                          
                        <p>Far far away, behind the word mountains.</p>
                        <img src="/assets/images/liked.png" class="pull-right large-like">
                      </div>
                    </div>
                  </div>

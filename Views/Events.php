<?php 
include '../Model/alleventsDAO.php';
    ...
    <div class="digisurf-container">
        <div class="digisurf-grid1 digisurf-sec-head">
            ...
            <ul class="nav  navbar-nav">
                <li class="dropdown">
                  <button class="btn btn-secondary dropdown-toggle video-sorter" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    Upcoming <i class="fa fa-arrow-down"></i>
                  </button>
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <li><a class="dropdown-item" href="#">Upcoming</a></li>
                    <li><a class="dropdown-item" href="#">Now in session</a></li>
            ...
            <h1 class="text-center"> Oct. 2019</h1>
                ...
                <div class="event-item">
                    <div class="event-item-in">
                        ...
                        <div class="event-item-bottom">
                            <div class="">
                                <p class="event-date">Aug 20 - Sep 20</p>
                                <h4>Title </h4>

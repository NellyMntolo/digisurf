<?php 
include '../Model/signup_verifyDAO.php';
        ...
        <div class="container cf">
            ...
            <section class="faq-section-header" style="background-image: url('/assets/images/about.jpg');">
                <div class="container">
                  <div class="row">
                    <div class="col-md-12">
                      <h2>welcome to Nothing is garbage</h2>                 
                    </div>
                  </div>
                </div>
            </section>
            ...
            <section class="faq-section ck">
                <div class="container">
                  <div class="row">
                    <div class="col-md-12">
                      <h1>Congratulations,<br> Your account has been approved, you can now login via the login button.</h1>             
                    </div>

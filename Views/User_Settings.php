        ...
        <div class="container cf">
            ...
            <section class="joinus-section">
                <div class="container">
                    ...
                    <form id="user_settings_form" action="/User_Settings_All" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
                      <div class="row">
                        <div class="col-md-3"> 
                        <div class="row">                     
                      ...
                      <div class="row">
                        <div class="col-md-3">
                          <div class="form-group">
                            <input type="text" name="customer_first_name" class="form-control" placeholder="User First Name">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-3">
                          <div class="form-group">
                            <input type="text" name="customer_last_name" class="form-control" placeholder="User Last Name">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-3">
                          <div class="form-group">
                            <input type="text" name="customer_address" class="form-control" placeholder="User Address">
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 ">
                                <div class="form-group join_us_submit">
                                    <input type="submit" name="customer_submit" class="form-control nominate_submit_btn" data-toggle="modal" data-target="#myusersettings" value="Submit">
                                </div> 
                            </div>
                        </div>

...
include_once("../Controller/forgotten_password_controller.php");
...
<section class="lvn-wrapper" style="background: url(/themes/greentheme/views/site/Assets/images/background-test-min.jpg) repeat-x center center fixed;">
	<div class="lvn-container ">
    	<form class="forgot-container" method="POST">
    	
            <h3>Recover my Account</h3>
            <p> Follow the instructions below to recover your account</p>
            <?php if(!empty($error)) echo '<div class="error">'.$error.'</div>'; ?>
            <div class="form-group">
            	<input type="email" class="form-control alt" id="inputEmail3" placeholder="Email" name="forgotten_email">
            </div>
            <div class="form-group">
            	<button name="forgotten_submit" type="submit" class="btn btn-info btn-block">Continue</button>
            </div>
        </form>
    </div>
</section>

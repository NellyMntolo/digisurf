            ...
            <div class="col-md-8">
                ...
                <form class="modal-cont" method="POST" id="loginForm">
                    ...
                    <div class="modal-login ">
                        ...
                        <!-- <a href="#">註冊</a> -->
                        <button type="submit" class="btn btn-green" name="login_submit">'.$log_in_text5.'</button>
                    </div>
                </form>
            </div>
        ...
        <div class="col-md-4 large-modal-image">
            ...
            <div class="col-md-8">
                ...
                <form class="modal-cont" >
                    <div class="form-group">
                       <h3 class="login-error">Wrong Username or Password，<br>
    Please try again.</h3>
                    </div>
                    <div class="form-group">
...
<div class="modal-dialog" role="document">
    <div class="modal-content mc2">
        ...
        <div class="col-md-4 large-modal-image">
            ...
            <div class="col-md-8">
                <div class="modal-title">
                    <h3>'.$log_in_text6.' Change Password</h3>
                </div>
                <form class="modal-cont" id="forgotten-password" method="post">
                    <div class="form-group">
                        <input type="text"  class="form-control forgotten-password" placeholder="'.$log_in_text7.'">
                    </div>
                    <div class="modal-buttons">
                        <button type="submit" class="btn btn-green">'.$log_in_text8.'</button>
                    </div>
                </form>
            </div>
    ...
    顯示的認證碼</h3>
                ...
                <form class="modal-cont" id="forgotten-reset" method="post">
                    <div class="form-group">
                        ...
                        <input type="hidden"  class="forgotten-reset-number">
                    </div>
                    <div class="modal-buttons">
                        <button type="submit" class="btn btn-green">'.$log_in_text8.'</button>
                    </div>
        ...
        <div class="col-md-4 large-modal-image">
            ...
            <div class="col-md-8">
                ...
                <form class="modal-cont" method="POST" id="newPass">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" id="newpass1" placeholder="New Password">
                    </div>
                    <div class="form-group">
...
<header class="" id="loggedin">
    <nav>
        ...
        <ul class="menu">
            ...
            <li><a href="/Terms" '.theUrl('/Terms').'>'.$menu_text6.'</a></li>
        ...
        <!--<ul class="others">-->
        <ul class="">
          <!-- <li class="admin">'.$menu_account.'</li>-->
            <li class="trigger">
                <div class="in"></div>
            </li>   
        </ul>

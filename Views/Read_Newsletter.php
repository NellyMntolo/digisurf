<?php 
include '../Model/readnewsletterDAO.php';
...
<main>
    <div class="main-container page-fix">
        <div class="container cf">
            ...
            <section class="about-section-header" style="background-image: url('<?php echo $newsletter_image1;?>');">
                <div class="container">
                  <div class="row">
                    <div class="col-md-12">
                      <h2><?php echo $newsletter_text3; ?></h2>                 
                    </div>
                  </div>
                </div>
            </section>
            ...
            <!-- <section class="about-section">
                <div class="container">
                  <div class="row">
                    <div class="col-md-12">
                      <h2><?php echo $newsletter_text4;?></h2>                      
                    </div>
                    <div class="col-md-12">
                      <?php echo $newsletter_text2;?>
                    </div>
                  </div>
                </div>
            </section> -->
            ...
            <section class="digisurf-wrapper bg3 col-md-12">
                <div class="digisurf-container">
                    <div class="digisurf-grid1 digisurf-sec-head">
                        <h1 class="text-center"><?php echo $newsletter_text4;?></h1>
                        <img src="<?php echo $newsletter_image1; ?>" class="newsletter_image">
                        <p class="text-center newsletter_content" style="text-align: justify;"><?php echo $newsletter_text2;?></p>
                    </div>
